#Temple of Droga (droga) >> Gillia_Brissok (81123)
...
sub EVENT_SPAWN {
    ...
    if(defined $qglobals{DroganSlave}) {
        switch($qglobals{DroganSlave}) {
            case 1:
                # Vaxxim T`Quoren
                quest::spawn2(81333,0,0,1298,-218,-252.13, 192);
                quest::depop();
                break;
            case 2:
                # Pagik Tsissun
                quest::spawn2(81334,0,0,1298,-218,-252.13, 192);
                quest::depop();
                break;
            case 3:
                # Asmodin Jru`dac
                quest::spawn2(81335,0,0,1298,-218,-252.13, 192);
                quest::depop();
                break;
            case 4:
                # Digmaster Duggert
                quest::spawn2(81336,0,0,1298,-218,-252.13, 192);
                quest::depop();
                break;
            case 5:
                quest::depop();
...
sub EVENT_TIMER {
    ...
    if($timer eq "Drogan_Slaves_Round_6") {
        ...
        if($named_up == 1) {
            ...
            $named_up = 3;
            quest::setglobal("DroganSlave", 1, 7, "F");
