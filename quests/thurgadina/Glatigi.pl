...
sub EVENT_SAY {
    if($faction <= 3) {
        # Require Warmly and greater faction
        if($text=~/Hail/i) {
...
sub EVENT_ITEM {
    if($faction <= 3) {
        # Require warmly and greater faction
        if(plugin::check_handin(\%itemcount, 25814 => 3, 24935 => 1)) {
            # tunic
        ...
        elsif (plugin::check_handin(\%itemcount, 25821 => 3, 24937 => 1)) {
            # sleeves
        ...
        elsif (plugin::check_handin(\%itemcount, 25825 => 3, 24936 => 1)) {
            # leggings
        ...
        elsif (plugin::check_handin(\%itemcount, 25832 => 3, 24941 => 1)) {
            # gauntlets
        ...
        elsif (plugin::check_handin(\%itemcount, 25831 => 3, 24940 => 1)) {
            # coif
        ...
        elsif (plugin::check_handin(\%itemcount, 25838 => 3, 24939 => 1)) {
            # bracers
        ...
        elsif (plugin::check_handin(\%itemcount, 25833 => 3, 24938 => 1)) {
            # boots
