...
sub EVENT_ITEM {
    if(plugin::check_handin(\%itemcount, 20376 => 1, 20383 => 1, 20377 => 1, 20538 => 1)) {
        ...
        quest::summonitem(20542); #Singing Short Sword (Bard 1.0 Epic)
        quest::ding(); quest::exp(350000);
        quest::shout2("Denizens of The Rathe. Please join me in congratulating $name for earning the Bard Epic: Singing Short Sword!");
        if($class ne 'Bard') {
