...
my $him = quest::saylink("him", 1);
  if($text=~/Hail/i) {
    quest::say("Hail $name, I am Jin Master Sergug, Wizard Guildmaster of the Guktan Army.");
...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 18367 => 1) && $class eq "Wizard") { 
    quest::say("I welcome you $name to the order of Jin, followers of Mithaniel Marr.");
    quest::say("Take this Robe and wear it with pride! May it protect you as you grow young Jin.");  
