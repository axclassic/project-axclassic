...
my $purge = quest::saylink("purge", 1);
	if ($text=~/Hail/i) {
		quest::emote(' shows the signs of a great mystic. You can feel the power resonating from his aura.');
		quest::say("Greetings and may the cursed blessings of Cazic-Thule be yours. What may I do for you this fine evening? Perhaps I can $cure disease or $heal you, perhaps even $purge toxins from your system?");
	}
	...
	if($text=~/Rok/i) {
		quest::say(' Mystic Dovan lowers his head in sorrow.');
        quest::say("Let us have a moment of peace. I cannot find the words to speak of the unspeakable act of the gods which took the lives of the legendary Crusaders of Rok Nolok. You must find the answers for yourself. All I can do is wait for their return.");
	}
...
sub EVENT_ITEM {
my $Galdon = quest::saylink("Galdon", 1);
	#Full C.O.R.N. Chest turn in and Cudgel of the Mystic
	if(plugin::check_handin(\%itemcount, 12736 => 1, 5143 => 1)) {
