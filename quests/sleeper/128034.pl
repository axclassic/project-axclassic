...
sub EVENT_SAY {
    ...
    elsif($text=~/fancy/i && !defined($Sleeperawake)) {
    ...
    elsif($text=~/adventuring/i && !defined($Sleeperawake)) {
    ...
    elsif($text=~/larger/i && !defined($Sleeperawake)) {
    ...
    elsif($text=~/stories/i && !defined($Sleeperawake)) {
    ...
    elsif($text=~/short/i && !defined($Sleeperawake)) {
    ...
    elsif($text=~/knowledge/i && !defined($Sleeperawake)) {
    ...
    elsif($text=~/couple/i && !defined($Sleeperawake)) {
