...
sub EVENT_SAY {
  ...
  my $motives = quest::saylink("motives", 1);
   if($text=~/hail/i && defined $qglobals{"Sleeperawake"} == 1){
    ...
    elsif($text=~/chaos/i && defined $qglobals{"Sleeperawake"} == 1){
	...
	elsif($text=~/abuse/i && defined $qglobals{"Sleeperawake"} == 1){
	...
	elsif($text=~/war/i && defined $qglobals{"Sleeperawake"} == 1){
	...
	elsif($text=~/tunnels/i && defined $qglobals{"Sleeperawake"} == 1){
    ...
    elsif($text=~/motives/i && defined $qglobals{"Sleeperawake"} == 1){	 
