...
sub EVENT_SAY {
my $Ulessa = quest::saylink("Ulessa", 1);
my $Milas = quest::saylink("Milas", 1);
my $trouble = quest::saylink("trouble", 1);
my $sleeping = quest::saylink("sleeping", 1);
my $planning = quest::saylink("planning", 1);
my $endeavor = quest::saylink("endeavor", 1);
my $something = quest::saylink("something", 1);
my $ancient = quest::saylink("ancient", 1);
my $door = quest::saylink("door", 1);
my $waiting = quest::saylink("waiting", 1);
my $help = quest::saylink("help", 1);
if($text=~/Hail/i) {
	quest::emote(' jolts his head in the direction of the voice.');
    quest::say("You. . . you're not an apparition are you? No, you can't be, that's what I am. Well, I'm glad to meet you, my name is Paldar Bladesoul. I don't suppose you've seen $Ulessa since you've entered this tomb, have you?");
	}
	elsif($text=~/Ulessa/i) {
	quest::emote(' looks away in disgust, whether for himself or for this Ulessa person, you dont know.');
    quest::say("Ulessa was my beloved wife. It seems so long since we were together, but life without essence is an eternity. She was the most beautiful woman I'd ever seen, and she entranced me beyond all thought. We came to this ominous tomb in search of our good friend $Milas, but we weren't aware of truly how dangerous this place was until we got here.");
	}
	elsif($text=~/Milas/i) {
