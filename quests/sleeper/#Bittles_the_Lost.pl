...
sub EVENT_SAY {
    ...
    elsif($text=~/disturbed/i && !defined($Sleeperawake)) {
    ...
    elsif($text=~/crazy/i && !defined($Sleeperawake)) {
    ...
    elsif($text=~/reassembled/i && defined($Sleeperawake)) {
    ...
    elsif($text=~/replaced/i && defined($Sleeperawake)) {
