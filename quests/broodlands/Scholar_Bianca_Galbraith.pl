...
if ($ulevel == 61 && plugin::check_handin(\%itemcount, 120153 => 1, 120154 => 1)) {
   ...
   elsif ($ulevel == 62 && plugin::check_handin(\%itemcount, 120153 => 1, 120154 => 1)) {
   quest::say("Yar`Lir doesn't stand a chance now, especially against someone as powerful as you. Dragons cannot hope to live forever and now is their dying hour. Well done against those generals and their guards!");
   quest::ding();
   quest::exp(2950220);
   quest::givecash(0,0,0,60);
   }
   elsif ($ulevel == 63 && plugin::check_handin(\%itemcount, 120153 => 1, 120154 => 1)) {
   quest::say("Yar`Lir doesn't stand a chance now, especially against someone as powerful as you. Dragons cannot hope to live forever and now is their dying hour. Well done against those generals and their guards!");
   quest::ding();
   quest::exp(3042940);
   quest::givecash(0,0,0,60);
   }
   elsif ($ulevel == 64 && plugin::check_handin(\%itemcount, 120153 => 1, 120154 => 1)) {
   quest::say("Yar`Lir doesn't stand a chance now, especially against someone as powerful as you. Dragons cannot hope to live forever and now is their dying hour. Well done against those generals and their guards!");
   quest::ding();
   quest::exp(3145220);
   quest::givecash(0,0,0,60);
   }
   elsif ($ulevel == 65 && plugin::check_handin(\%itemcount, 120153 => 1, 120154 => 1)) {
   quest::say("Yar`Lir doesn't stand a chance now, especially against someone as powerful as you. Dragons cannot hope to live forever and now is their dying hour. Well done against those generals and their guards!");
   quest::ding();
   quest::exp(3245060);
   quest::givecash(0,0,0,60);
   ...
   elsif ($ulevel == 62 && plugin::check_handin(\%itemcount, 81902 => 1)) {
   quest::say("Ah, what abeautiful flower. Thank you $name.");
   quest::ding();
   quest::exp(2950220);
   quest::givecash(0,0,0,60);
   }
   elsif ($ulevel == 63 && plugin::check_handin(\%itemcount, 81902 => 1)) {
   quest::say("Ah, what abeautiful flower. Thank you $name.");
   quest::ding();
   quest::exp(3042940);
   quest::givecash(0,0,0,60);
   }
   elsif ($ulevel == 64 && plugin::check_handin(\%itemcount, 81902 => 1)) {
   quest::say("Ah, what abeautiful flower. Thank you $name.");
   quest::ding();
   quest::exp(3145220);
   quest::givecash(0,0,0,60);
   }
   elsif ($ulevel == 65 && plugin::check_handin(\%itemcount, 81902 => 1)) {
   quest::say("Ah, what abeautiful flower. Thank you $name.");
   quest::ding();
   quest::exp(3245060);
   quest::givecash(0,0,0,60);
   ...
   elsif ($ulevel == 62 && plugin::check_handin(\%itemcount, 120185 => 1)) {
   quest::say("Hopefully that will disrupt the organization and give us the fighting chance we need against Yar'Lir");
   quest::ding();
   quest::exp(2950220);
   quest::givecash(0,0,0,60);
   }
   elsif ($ulevel == 63 && plugin::check_handin(\%itemcount, 120185 => 1)) {
   quest::say("Hopefully that will disrupt the organization and give us the fighting chance we need against Yar'Lir");
   quest::ding();
   quest::exp(3042940);
   quest::givecash(0,0,0,60);
   }
   elsif ($ulevel == 64 && plugin::check_handin(\%itemcount, 120185 => 1)) {
   quest::say("Hopefully that will disrupt the organization and give us the fighting chance we need against Yar'Lir");
   quest::ding();
   quest::exp(3145220);
   quest::givecash(0,0,0,60);
   }
   elsif ($ulevel == 65 && plugin::check_handin(\%itemcount, 120185 => 1)) {
   quest::say("Hopefully that will disrupt the organization and give us the fighting chance we need against Yar'Lir");
   quest::ding();
   quest::exp(3245060);
   quest::givecash(0,0,0,60);
   ...
   elsif ($ulevel == 62 && plugin::check_handin(\%itemcount, 86009 => 1)) {
   quest::say("Excellent work, my friends. Lieutenant Ekiltu hasn't rested since he found that rose in his quarters. It's too bad the Dark Reign cowards hire goblin assassins to do their dirty work; I would like to see them try to confront us directly. No matter, we will crush them on the field of battle soon enough.");
   quest::ding();
   quest::exp(2950220);
   quest::givecash(0,0,0,60);
   }
   elsif ($ulevel == 63 && plugin::check_handin(\%itemcount, 86009 => 1)) {
   quest::say("Excellent work, my friends. Lieutenant Ekiltu hasn't rested since he found that rose in his quarters. It's too bad the Dark Reign cowards hire goblin assassins to do their dirty work; I would like to see them try to confront us directly. No matter, we will crush them on the field of battle soon enough.");
   quest::ding();
   quest::exp(3042940);
   quest::givecash(0,0,0,60);
   }
   elsif ($ulevel == 64 && plugin::check_handin(\%itemcount, 86009 => 1)) {
   quest::say("Excellent work, my friends. Lieutenant Ekiltu hasn't rested since he found that rose in his quarters. It's too bad the Dark Reign cowards hire goblin assassins to do their dirty work; I would like to see them try to confront us directly. No matter, we will crush them on the field of battle soon enough.");
   quest::ding();
   quest::exp(3145220);
   quest::givecash(0,0,0,60);
   }
   elsif ($ulevel == 65 && plugin::check_handin(\%itemcount, 86009 => 1)) {
   quest::say("Excellent work, my friends. Lieutenant Ekiltu hasn't rested since he found that rose in his quarters. It's too bad the Dark Reign cowards hire goblin assassins to do their dirty work; I would like to see them try to confront us directly. No matter, we will crush them on the field of battle soon enough.");
   quest::ding();
   quest::exp(3245060);
   quest::givecash(0,0,0,60);
   ...
   elsif ($ulevel == 62 && plugin::check_handin(\%itemcount, 81891 => 1, 81892 => 1, 81890 => 1)) {
   quest::say("Excellent work, my friends.Now that we have the Statues in our possession, that should calm the storms over Broodlands.");
   quest::ding();
   quest::exp(2950220);
   quest::givecash(0,0,0,60);
   }
   elsif ($ulevel == 63 && plugin::check_handin(\%itemcount, 81891 => 1, 81892 => 1, 81890 => 1)) {
   quest::say("Excellent work, my friends.Now that we have the Statues in our possession, that should calm the storms over Broodlands.");
   quest::ding();
   quest::exp(3042940);
   quest::givecash(0,0,0,60);
   }
   elsif ($ulevel == 64 && plugin::check_handin(\%itemcount, 81891 => 1, 81892 => 1, 81890 => 1)) {
   quest::say("Excellent work, my friends.Now that we have the Statues in our possession, that should calm the storms over Broodlands.");
   quest::ding();
   quest::exp(3145220);
   quest::givecash(0,0,0,60);
   }
   elsif ($ulevel == 65 && plugin::check_handin(\%itemcount, 81891 => 1, 81892 => 1, 81890 => 1)) {
   quest::say("Excellent work, my friends.Now that we have the Statues in our possession, that should calm the storms over Broodlands.");
   quest::ding();
   quest::exp(3245060);
   quest::givecash(0,0,0,60);
   ...
   elsif ($ulevel == 62 && plugin::check_handin(\%itemcount, 60258 => 1, 60260 => 1, 60259 => 1)) {
   quest::say("You have done well to find the tomes of the scions and use the very power that they were instilled with by Yar`Lir against them. Their deaths will leave an invaluable hole in her operations that you will be able to exploit in the time to come. Keep on your toes, however. Yar`Lir is a powerful being and has no doubt seen your attempts to destroy her and her kind.");  
   quest::ding();
   quest::exp(2950220);
   quest::givecash(0,0,0,60);
   }
   elsif ($ulevel == 63 && plugin::check_handin(\%itemcount, 60258 => 1, 60260 => 1, 60259 => 1)) {
   quest::say("You have done well to find the tomes of the scions and use the very power that they were instilled with by Yar`Lir against them. Their deaths will leave an invaluable hole in her operations that you will be able to exploit in the time to come. Keep on your toes, however. Yar`Lir is a powerful being and has no doubt seen your attempts to destroy her and her kind.");  
   quest::ding();
   quest::exp(3042940);
   quest::givecash(0,0,0,60);
   }
   elsif ($ulevel == 64 && plugin::check_handin(\%itemcount, 60258 => 1, 60260 => 1, 60259 => 1)) {
   quest::say("You have done well to find the tomes of the scions and use the very power that they were instilled with by Yar`Lir against them. Their deaths will leave an invaluable hole in her operations that you will be able to exploit in the time to come. Keep on your toes, however. Yar`Lir is a powerful being and has no doubt seen your attempts to destroy her and her kind.");  
   quest::ding();
   quest::exp(3145220);
   quest::givecash(0,0,0,60);
   }
   elsif ($ulevel == 65 && plugin::check_handin(\%itemcount, 60258 => 1, 60260 => 1, 60259 => 1)) {
   quest::say("You have done well to find the tomes of the scions and use the very power that they were instilled with by Yar`Lir against them. Their deaths will leave an invaluable hole in her operations that you will be able to exploit in the time to come. Keep on your toes, however. Yar`Lir is a powerful being and has no doubt seen your attempts to destroy her and her kind.");  
   quest::ding();
   quest::exp(3245060);
   quest::givecash(0,0,0,60);
   ...
   elsif ($ulevel == 62 && plugin::check_handin(\%itemcount, 120167 => 1)) {
   quest::say("Well wasnt that nice of her. I guess that she is grateful for being alive.");
   quest::ding();
   quest::exp(2950220);
   quest::givecash(0,0,0,60);
   }
   elsif ($ulevel == 63 && plugin::check_handin(\%itemcount, 120167 => 1)) {
   quest::say("Well wasnt that nice of her. I guess that she is grateful for being alive.");
   quest::ding();
   quest::exp(3042940);
   quest::givecash(0,0,0,60);
   }
   elsif ($ulevel == 64 && plugin::check_handin(\%itemcount, 120167 => 1)) {
   quest::say("Well wasnt that nice of her. I guess that she is grateful for being alive.");
   quest::ding();
   quest::exp(3145220);
   quest::givecash(0,0,0,60);
   }
   elsif ($ulevel == 65 && plugin::check_handin(\%itemcount, 120167 => 1)) {
   quest::say("Well wasnt that nice of her. I guess that she is grateful for being alive.");
   quest::ding();
   quest::exp(3245060);
   quest::givecash(0,0,0,60);
   ...
   elsif ($ulevel == 62 && plugin::check_handin(\%itemcount, 60257 => 1)) {
   quest::say("The Crystal! The Keepers of Norrath thank you. The last thing we need is for this to fall into the hands of the Dark Reign.");
   quest::ding();
   quest::exp(2950220);
   quest::givecash(0,0,0,60);
   }
   elsif ($ulevel == 63 && plugin::check_handin(\%itemcount, 60257 => 1)) {
   quest::say("The Crystal! The Keepers of Norrath thank you. The last thing we need is for this to fall into the hands of the Dark Reign.");
   quest::ding();
   quest::exp(3042940);
   quest::givecash(0,0,0,60);
   }
   elsif ($ulevel == 64 && plugin::check_handin(\%itemcount, 60257 => 1)) {
   quest::say("The Crystal! The Keepers of Norrath thank you. The last thing we need is for this to fall into the hands of the Dark Reign.");
   quest::ding();
   quest::exp(3145220);
   quest::givecash(0,0,0,60);
   }
   elsif ($ulevel == 65 && plugin::check_handin(\%itemcount, 60257 => 1)) {
   quest::say("The Crystal! The Keepers of Norrath thank you. The last thing we need is for this to fall into the hands of the Dark Reign.");
   quest::ding();
   quest::exp(3245060);
   quest::givecash(0,0,0,60);
