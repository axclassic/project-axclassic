...
sub EVENT_ITEM {
    if($faction == 1) {
        #requires ally Kromzek faction
        if(plugin::check_handin(\%itemcount, 25831 => 3, 24912 => 1)) {
            # cap
        ...
        elsif (plugin::check_handin(\%itemcount, 25814 => 3, 24907 => 1)) {
            # bp
        ...
        elsif (plugin::check_handin(\%itemcount, 25821 => 3, 24909 => 1)) {
            # sleeves
        ...
        elsif (plugin::check_handin(\%itemcount, 25838 => 3, 24911 => 1)) {
            # wrist
        ...
        elsif (plugin::check_handin(\%itemcount, 25832 => 3, 24913 => 1)) {
            # gloves
        ...
        elsif (plugin::check_handin(\%itemcount, 25825 => 3, 24908 => 1)) {
            # legs
        ...
        elsif (plugin::check_handin(\%itemcount, 25833 => 3, 24910 => 1)) {
            # boots
            ...
            quest::say("I am not interested in that.");
