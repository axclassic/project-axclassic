...
if ($text=~/Hail/i && defined $qglobals{"Djinnfive"} == 1) {
...
elsif ($text=~/captains/i && defined $qglobals{"Djinnfive"} == 1) {
...
elsif ($text=~/chance/i && defined $qglobals{"Djinnfive"} == 1) {
...
elsif ($text=~/Hail/i && defined $qglobals{"Djinnthree"} == 1) {
quest::say("You have business with my brother Driya to complete $name, I am too busy to help you right now.");
}
elsif ($text=~/Hail/i && defined $qglobals{"Djinnfour"} == 1) {
quest::say("You have business with my brother Driya to complete $name, I am too busy to help you right now.");
}
elsif ($text=~/Hail/i && defined $qglobals{"Djinnsix"} == 1) {
quest::say("You have business with my brother Drizmun to complete $name, I am too busy to help you right now.");
}
elsif ($text=~/Hail/i && defined $qglobals{"Djinnseven"} == 1) {
quest::say("You have business with my brother Drizmun to complete $name, I am too busy to help you right now.");
}
elsif ($text=~/Hail/i && defined $qglobals{"Djinneight"} == 1) {
quest::say("You have business with my brother Drizmun to complete $name, I am too busy to help you right now.");
}
else {
