...
if ($text=~/Hail/i && defined $qglobals{"Djinnsix"}) {
...
elsif ($text=~/Guardians/i && defined $qglobals{"Djinnseven"}) {
...
elsif ($text=~/strike/i && defined $qglobals{"Djinnseven"}) {
...
elsif ($text=~/Hail/i && defined $qglobals{"Djinnone"}) {
quest::say("You have business with my brother Driya to complete $name, I am too busy to help you right now.");
}
elsif ($text=~/Hail/i && defined $qglobals{"Djinntwo"}) {
quest::say("You have business with my brother Driya to complete $name, I am too busy to help you right now.");
}
elsif ($text=~/Hail/i && defined $qglobals{"Djinnthree"}) {
