...
my $pact = quest::saylink("pact", 1);
	...
	elsif(($text=~/Gods/i) && defined $qglobals{"Djinnone"}) {
	...
	elsif(($text=~/magical/i) && defined $qglobals{"Djinnone"}) {
	...
	elsif(($text=~/energy/i) && defined $qglobals{"Djinnone"}) {
	...
	elsif(($text=~/offer/i) && defined $qglobals{"Djinnone"}) {
	...
	elsif(($text=~/free/i) && defined $qglobals{"Djinnone"}) {
	...
	elsif(($text=~/pact/i) && defined $qglobals{"Djinnone"}) {
