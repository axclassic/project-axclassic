sub EVENT_SAY{
if($text=~/Hail/i){
quest::say("Ahh. hello there $name.  I am a trader from Sanctus Seru trying to make my way to Shadowhaven for some dealings.  I have come this far with the aid of guards from Sanctus Seru. but they have turn back and left me to go on my own.  I hear there are many terrible [creatures] here lurking in the shadows. leave it to the guards of the Hand to leave me unprotected.");
}
...
if($text=~/i will help by providing safe passage/i){
