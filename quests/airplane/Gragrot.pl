...
quest::say("Great, let us waste no more time!  I offer to you three challenges,  Bash, smash, or slash?  What do you wish to be tested in?");
  ...
  if ($text=~/bash/i) { #shadowknight test of bash
    quest::say("Gragrot like bashin. Gragrot say you like bashin too! Give Gragrot an Ebon Tessera, a Sphinx Eye Opal, and a Finely Crafted Amulet. Gragrot then give you a Sphinx Eye Amulet.");
    }
