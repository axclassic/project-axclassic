...
sub EVENT_SAY {
   ...
   if($text=~/strength/i) { #monk test of strength
      quest::say("So be it, the test of Strenth you shall have. Bring to me a Verdant Tessera, some Finely Woven Gold Mesh,  and some Silken Strands. The task will not be easy, but it should serve as an adequate test of Strength for one of your abilities.");
   }
