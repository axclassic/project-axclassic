...
sub EVENT_SAY {
  if ($text=~/hail/i) {
    quest::say("$name, let us waste no more time! I offer to you four challenges: Disempowement, Envenoming,  Raising of the Dead, or Necropotence. Choose one and be tested.");
    }
