...
sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 20934 => 1, 20834 => 1, 20835 => 1)) { #shaman test of might using auburn tessera, drake fang, leather cord
  ...
  elsif(plugin::check_handin(\%itemcount, 20947 => 1, 20839 => 1, 20840 => 1)) { #shaman test of sight using phosphoric globe, sphinx hide, light damask mantle
