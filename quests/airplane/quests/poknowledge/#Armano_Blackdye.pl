...
mercenaries armour with a #bot $command . All you have to do is visit my brother Dino and let him fill this vial. The last time I have seen him he was located in the Southern plains of the Karranas close to the Lake Rathe zone. If you hurry I'll tell you some news I just heard. Hurry now...");
...
$client->Message(14,"Wonderfull, I see you have spoken to my brother. How is he doing? Well as promissed here is your #bot armorcolor skill, Myz Rexxal has been grumpy since his sister issue. If you see him stop by and say hello might make him feel better.");
quest::ding();
quest::exp(1000);
