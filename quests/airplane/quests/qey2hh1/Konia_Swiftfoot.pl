...
sub EVENT_SAY { 
  ...
  if ($text=~/ready/i) {
    ...
    quest::summonitem(20532); #Torch of Misty
  }
}

sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 20379 => 1)) { #Proof of Speed
    ...
    quest::summonitem(20376); #Maestro's Symphony Page 24 Top
  }
  elsif (plugin::check_handin(\%itemcount, 20366 => 1)) { #Mahlin's Mystical Bongos
    ...
    quest::summonitem(20383); #Maestro's Symphony Page 24 Bottom
  }
  else {
