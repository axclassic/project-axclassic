...
my $mithril = quest::saylink("mithril ore");
my $chainmail = quest::saylink("mithril chainmail");
my $enchanted = quest::saylink("enchanted mithril");

 
if($text=~/Hail/i){
quest::say("Well met. $name! I am Tanalin Silverkale, provider of the finest $mithril and master craftsman of $chainmail!");
}
