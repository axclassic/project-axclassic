...
sub EVENT_SAY {
  ...
  if ($text=~/Draconic Loyalist Fellowship/i) {
  ...
  if ($text=~/hunting for lost artifacts/i) {
  ...
  if ($text=~/crystalline silk mesh/i) {
  ...
  if ($text=~/platinum dragon scale/i) {
  ...
  if ($text=~/dragon scripture tablet/i) {
