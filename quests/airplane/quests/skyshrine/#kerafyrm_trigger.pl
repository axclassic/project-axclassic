...
sub EVENT_TIMER {
 if($timer eq "kerafyrma" && $qglobals{kerafyrm} == 1) {
 ...
 elsif($timer eq "kerafyrma" && $qglobals{kerafyrm} == 2) {
 ...
 if($timer eq "kerafyrmb" && $qglobals{kerafyrm} == 2) {
 ...
 if($timer eq "kerafyrmc" && $qglobals{kerafyrm} == 3) {
