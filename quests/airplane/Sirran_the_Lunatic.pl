...
sub EVENT_SAY {
   if($text=~/hail/i) { #island1
      ...
      if($sirran == 7) { #island7
         quest::say("$name! The tears are welling up in my eyes! I am so proud. I think of you as if I were your father! Sniff. Sniff. Give me Veeshan, and I give you death");
      }
   }
...
# Sirran_the_Lunatic NPCID: 71058
