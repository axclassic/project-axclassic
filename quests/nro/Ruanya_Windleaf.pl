        ...
        if(defined($qglobals{Wayfarer}) && ($qglobals{Wayfarer} == 1)) {
            ...
            if($text=~/farstone/i) {
                ...
                if(!$client->KeyRingCheck(41000) && !plugin::check_hasitem($client,41000)) {
                    ...
                    if($tak_wins < 2) {
                    ...
                    elsif($tak_wins >= 4 && $qglobals{TAKtalk} == 1) {
                        #4 wins
                    ...
                    elsif($tak_wins >= 6 && $qglobals{TAKtalk} == 2) {
                        #6 wins
                    ...
                    elsif($tak_wins >= 8 && $qglobals{TAKtalk} == 3) {
                        #8 wins
                    ...
                    elsif($tak_wins >= 10 && $qglobals{TAKtalk} == 4) {
                        #10 wins - Power Up
                    ...
                    elsif($tak_wins >= 12 && $qglobals{TAKtalk} == 5) {
                        #12 wins
                    ...
                    elsif($tak_wins >= 26 && $qglobals{TAKtalk} == 12) {
                        #26 wins
                    ...
                    elsif($tak_wins >= 28 && $qglobals{TAKtalk} == 13) {
                        #28 wins
                    ...
                    elsif($tak_wins >= 30 && $qglobals{TAKtalk} == 14) {
                        #30 wins - Power Up
                    ...
                    elsif($tak_wins >= 32 && $qglobals{TAKtalk} == 15) {
                        #32 wins
                    ...
                    elsif($tak_wins >= 34 && $qglobals{TAKtalk} == 16) {
                        #34 wins
                    ...
                    elsif($tak_wins >= 36 && $qglobals{TAKtalk} == 17) {
                        #36 wins
                    ...
                    elsif($tak_wins >= 38 && $qglobals{TAKtalk} == 18) {
                        #38 wins
                    ...
                    elsif($tak_wins >= 40 && $qglobals{TAKtalk} == 19) {
                        #Send to other NPC
                        $client->Message(13, "You have additional information to uncover! You must speak to Niflel Faliwae to find out more.");
                    }
                    ...
                    elsif($tak_wins >= 70 && $qglobals{TAKtalk} == 34) {
                        #70 wins - Power Up
                    ...
                    elsif($tak_wins >= 72 && $qglobals{TAKtalk} == 35) {
                        #72 wins
                    ...
                    elsif($tak_wins >= 74 && $qglobals{TAKtalk} == 36) {
                        #74 wins
                    ...
                    elsif($tak_wins >= 76 && $qglobals{TAKtalk} == 37) {
                        #76 wins
                    ...
                    elsif($tak_wins >= 78 && $qglobals{TAKtalk} == 38) {
                        #78 wins - Power Up
                        ...
                        $client->Message(15, "You have received an invaluable piece of information!");
                        $client->Message(15, "Your Adventurer Stone glows with more power as you gain stature with the Wayfarers Brotherhood.");
                        if($qglobals{MMCtalk} == 38 && $qglobals{RUJtalk} == 37 && $qglobals{MIRtalk} == 34 && $qglobals{GUKtalk} == 35) {
