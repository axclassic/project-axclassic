...
my $task = quest::saylink("task", 1);
   if (plugin::check_handin(\%itemcount, 5558 =>1 )) {
    quest::say("I see that you have experienced some training from Elder Ternq. He is an amazing scout and very exciting to watch in combat. Years prior to being commissioned to act in this role, I served with the young Scout Ternq. Of course we were both much younger and more agile back in those days. Much like you are now. Ah well, enough with this chatter. Take this bag and stow it somewhere safe. I have a $task for you.");
    quest::summonitem(17117);
    quest::summonitem(5558);
    }
   elsif (plugin::check_handin(\%itemcount, 6274 =>1 )) {
