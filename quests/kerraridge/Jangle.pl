...
quest::say("I would love to fill this order for you friend, but the lad that we sent out into the moor to hunt up our last batch of owlbear guts has not returned. No guts, no strings. I'm afraid that I have neither.");
quest::say("If your master will allow it, perhaps you could go gather the guts for me. If you complete this task, I will waive the fee for his next couple of orders. I'm sure that he'll find that proposal pleasant enough. Here's a bag to gather the guts in. Please fill it before you return to me.");
quest::summonitem(17612);
}
elsif(plugin::check_handin(\%itemcount,5961 => 1)){
...
elsif(plugin::check_handin(\%itemcount,5963 => 1)){
