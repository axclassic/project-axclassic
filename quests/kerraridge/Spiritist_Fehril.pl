...
elsif(plugin::check_handin(\%itemcount, 3488 => 3)){
quest::say("You've completed my first task and as a reward I shall present you with this small token."); 
quest::emote(' craftily places the hides in a circular frame and hands you the product');
quest::summonitem(3489); #Hopper hide Buckler.
quest::say("May it serve to protect you from our enemies.");
...
elsif(plugin::check_handin(\%itemcount, 3493 => 1)){
...
quest::say("Citizens often need assistance and the Dar Khura must be available whenever possible. Merchant Ayyad has requested someone to run an errand and I am sending you.");
quest::say("Return to me with Merchant Ayyad's $seal, the hide treatment, your buckler, and your initiate's cloak.");
quest::summonitem(3494); #Hopperhide Treatment.
quest::exp(500);
}
elsif(plugin::check_handin(\%itemcount, 3489 => 1, 3494 => 1, 3499 => 1, 2878 => 1)){
quest::say("Well done you $name, your deeds will not go unnoticed. You will now be known throughout the land as an official recruit of the revered Dar Khura. As your status improves so will the rewards for your service. Here is your treated buckler, your new cloak, and a spell I trust you will find a use for. Go talk to Fharra Cawfeet and she will continue your training.");
quest::shout("My fellow Vah Shir, I present to you the newest recruit to the sacred Dar Khura. $name has shown great potential in the service of our sect. Please join me in thanking this citizen for service to our people!");
...
elsif (plugin::check_handin(\%itemcount, 5542 => 1, 3496 => 1, 5543 => 1)) {
...
quest::say(" to advance you rank further, you should seek out Jaima Seyel, She can assist you.");
}
else {
