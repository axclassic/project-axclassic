...
my $time = quest::saylink("time", 1);
 if ($text=~/hail/i) {
    quest::say("Good Day to you citizen, How may I assist you?");
    }
  if ($text=~/time/i) {
    quest::say("Shields and bucklers are very versatile. They can be used to deflect blows, knock your opponents off balance, and even offer a secondary form of attack. If you want me to help you to modify your shield, I'll need you to gather some rough ore pieces. They can be taken from the rhinobeetles that reside in the moor. Place them in a forge with a flask of water and your set of files to create bolts. fill the bag with crude bolts and combine them. Return to me with a bag of bolts and your buckler.");
  }
}
...
sub EVENT_ITEM {
  ...
  elsif (plugin::check_handin(\%itemcount, 5556 =>1, 3452=>1 )) {
    quest::say("Thank you for making those for me. I was almost out. I'll modify your buckler immediately after I finish what I am doing here. Meanwhile, take this shopping list to Friaz Ompir. Do what you can to assist her. I need the bag of beetle horns she will give you if I am to work on your shield today.");
  quest::summonitem(18321);
  quest::summonitem(5546);
    
  }
  elsif (plugin::check_handin(\%itemcount, 5549 =>1 )) {
