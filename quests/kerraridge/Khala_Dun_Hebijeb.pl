...
sub EVENT_ITEM {
  ...
  elsif (plugin::check_handin(\%itemcount, 3451 =>1, 3445=>1, 2878=>1 )) {
    ...
    quest::say("To further your training speak with Armsman Khaigesh, show him your buckler. Safe journey's $name."); 
