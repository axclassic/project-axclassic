...
sub EVENT_SAY {
if ($text=~/Hail/i) {
quest::say("Good day to you citizen, is there something I can help you with?");
}
if ($text=~/wolves/i) {
...
my $wolves = quest::saylink("wolves", 1);
  ...
  if (plugin::check_handin(\%itemcount, 6158 =>1, 5966 =>1 )) {
    ...
    quest::say("To furthrt your studies, you much venture to Hollowshade Moor and seek out Ahom Guzhin. He will istruct you on what is further needed.");
