#############
#Quest Name:Tunarean Scout Final Favor
#NPCs Involved: Tilania Shadowwalker
#Items Involved:Tunarean Scouts Training Dagger
#zone: gfaydark

sub EVENT_SAY {

    my $training = quest::saylink("What training?");
    my $rogue = quest::saylink("I am a Rogue of Tunare.");
    my $magical = quest::saylink("What magical armor materials?");
    my $continue = quest::saylink("continue...");
    my $Coifs = quest::saylink("I want to craft a coif.");
    my $Bracers = quest::saylink("I want to craft a bracer.");
    my $Sleeves = quest::saylink("I want to craft sleeves.");
    my $Boots = quest::saylink("I want to craft boots.");
    my $Legplates = quest::saylink("I want to craft legplates.");
    my $Gauntlets = quest::saylink("I want to craft gauntlets.");
    my $Tunics = quest::saylink("I want to craft a tunic.");
    my $favor = quest::saylink("What favor?");
    my $specific = quest::saylink("What specific items?");
    ...
    if($text=~/i am a rogue of tunare/i) {
        quest::say("Excellent $name. Let us get started then. Your training will test your fighting and gathering skills respectively. The items you will be required to gather are all over the Faydark for $magical armor materials.");
    }
...
sub EVENT_ITEM {
    if(plugin::check_handin(\%itemcount, 27536 => 2, 27535 => 1)) {
        quest::summonitem(27530);
        quest::say("You have done well. There was no doubt in my mind that you could be counted on for this important mission. Please take this Training Dagger as a symbol of your dedication.");
