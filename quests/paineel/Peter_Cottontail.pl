#Peter_Cottontail ID 75171 Paineel##
#New Easter Event ##
...
sub EVENT_ITEM {
    ...
    elsif(($ulevel == 50) && ($itemcount{120282}
                              == 1)) {
        quest::say("Well done $name, here is your reward.");
        quest::summonitem(120323); #Easter event Lucky Rabbit Foot Aug
        quest::summonitem(120314); #Special Event Distiller
    ...
    elsif(($ulevel == 51) && ($itemcount{120282}
                              == 1)) {
        quest::say("Well done $name, here is your reward.");
        quest::summonitem(120323); #Easter event Lucky Rabbit Foot Aug
        quest::summonitem(120314); #Special Event Distiller
    ...
    elsif(($ulevel == 52) && ($itemcount{120282}
                              == 1)) {
        quest::say("Well done $name, here is your reward.");
        quest::summonitem(120323); #Easter event Lucky Rabbit Foot Aug
        quest::summonitem(120314); #Special Event Distiller
    ...
    elsif(($ulevel == 53) && ($itemcount{120282}
                              == 1)) {
        quest::say("Well done $name, here is your reward.");
        quest::summonitem(120323); #Easter event Lucky Rabbit Foot Aug
        quest::summonitem(120314); #Special Event Distiller
    ...
    elsif(($ulevel == 54) && ($itemcount{120282}
                              == 1)) {
        quest::say("Well done $name, here is your reward.");
        quest::summonitem(120323); #Easter event Lucky Rabbit Foot Aug
        quest::summonitem(120314); #Special Event Distiller
    ...
    elsif(($ulevel == 55) && ($itemcount{120282}
                              == 1)) {
        quest::say("Well done $name, here is your reward.");
        quest::summonitem(120323); #Easter event Lucky Rabbit Foot Aug
        quest::summonitem(120314); #Special Event Distiller
    ...
    elsif(($ulevel == 56) && ($itemcount{120282}
                              == 1)) {
        quest::say("Well done $name, here is your reward.");
        quest::summonitem(120323); #Easter event Lucky Rabbit Foot Aug
        quest::summonitem(120314); #Special Event Distiller
    ...
    elsif(($ulevel == 57) && ($itemcount{120282}
                              == 1)) {
        quest::say("Well done $name, here is your reward.");
        quest::summonitem(120323); #Easter event Lucky Rabbit Foot Aug
        quest::summonitem(120314); #Special Event Distiller
    ...
    elsif(($ulevel == 58) && ($itemcount{120282}
                              == 1)) {
        quest::say("Well done $name, here is your reward.");
        quest::summonitem(120323); #Easter event Lucky Rabbit Foot Aug
        quest::summonitem(120314); #Special Event Distiller
    ...
    elsif(($ulevel == 59) && ($itemcount{120282}
                              == 1)) {
        quest::say("Well done $name, here is your reward.");
        quest::summonitem(120323); #Easter event Lucky Rabbit Foot Aug
        quest::summonitem(120314); #Special Event Distiller
    ...
    elsif(($ulevel == 60) && ($itemcount{120282}
                              == 1)) {
        quest::say("Well done $name, here is your reward.");
        quest::summonitem(120323); #Easter event Lucky Rabbit Foot Aug
        quest::summonitem(120314); #Special Event Distiller
    ...
    elsif(($ulevel == 61) && ($itemcount{120282}
                              == 1)) {
        quest::say("Well done $name, here is your reward.");
        quest::summonitem(120323); #Easter event Lucky Rabbit Foot Aug
        quest::summonitem(120314); #Special Event Distiller
    ...
    elsif(($ulevel == 62) && ($itemcount{120282}
                              == 1)) {
        quest::say("Well done $name, here is your reward.");
        quest::summonitem(120323); #Easter event Lucky Rabbit Foot Aug
        quest::summonitem(120314); #Special Event Distiller
    ...
    elsif(($ulevel == 63) && ($itemcount{120282}
                              == 1)) {
        quest::say("Well done $name, here is your reward.");
        quest::summonitem(120323); #Easter event Lucky Rabbit Foot Aug
        quest::summonitem(120314); #Special Event Distiller
    ...
    elsif(($ulevel == 64) && ($itemcount{120282}
                              == 1)) {
        quest::say("Well done $name, here is your reward.");
        quest::summonitem(120323); #Easter event Lucky Rabbit Foot Aug
        quest::summonitem(120314); #Special Event Distiller
    ...
    elsif(($ulevel == 65) && ($itemcount{120282}
                              == 1)) {
        quest::say("Well done $name, here is your reward.");
        quest::summonitem(120323); #Easter event Lucky Rabbit Foot Aug
        quest::summonitem(120314); #Special Event Distiller
