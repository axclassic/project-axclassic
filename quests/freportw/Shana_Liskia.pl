...
# DATABASE: PEQ-Velios
# LAST EDIT DATE: November 10, 2019
# VERSION: 2.0
# DEVELOPER: MWMDRAGON
# UPDATED BY: Fulcrum
# *** NPC INFORMATION ***
...
#
#*Edited to allow all to run these quests for bot equipment.
############################################

sub EVENT_SAY { 
    if ($text=~/hail/i) { 
       quest::say("Hail and well met $name. I am Shana Liskia. Enchantress of Freeport. I have studied my art for years here in our wonderful academy. I am also delighted to meet and teach those that come here to gain knowledge. My specialty however lies in Beguiling so I like to train young newcomers to our academy. Are you or one of your friends studying the ways of a [Magician] an [Enchanter] or a [Wizard]??"); 
    } 
	...
	if ($text=~/ready to begin/i) { 
      quest::say("Very well. Here you are $name. in this box you will combine specific component recipes as I mentioned before. When you are ready to attempt a specific piece you must tell me what piece you [want] to craft. For example if you had intent on crafting a cap you would say. [I want to craft a cap]. I can offer you the recipes for Arcane Scientists [Caps]. [Bracers]. [Sleeves]. [Sandals]. [Leggings]. [Gloves] and [Robes]. I must also suggest that you attempt your robe last due to the difficult nature of collecting the correct components."); 
	    # Item Number for the Enchanted Sewing Kit #17260
    ...
    if ($text=~/bracers/i) { 
      ...
      # Item Number for An Enchanted Bracer Pattern #22584
    ...
    if ($text=~/caps/i) { 
      ...
      # An Enchanted Cap Pattern #22583
    ...
    if ($text=~/gloves/i) { 
      ...
      # An Enchanted Gloves Pattern #22588
    ...
    if ($text=~/sandals/i) { 
      ...
      # An Enchanted Sandals Pattern #22585
    ...
    if ($text=~/sleeves/i) { 
      ...
      # Item Number for An Enchanted Sleeves Pattern #22586
    ...
    if ($text=~/leggings/i) { 
      ...
      # An Enchanted Trousers Pattern #22587
    ...
    if ($text=~/robes/i) { 
      ...
      # An Enchanted Robe Pattern #22589
...
sub EVENT_ITEM { 
    if (plugin::check_handin(\%itemcount, 9917 => 2, 9933 => 1)) { # Lion Tooth #9917 and Shanas Necklace #9933
      quest::summonitem(9938); # Dagger of the Academy #9938
      quest::say("Thank you for bringing back one of my most valued possesion, $name. You have proven yourself to be worthy to wield the Dagger of the Academy."); 
    } 
    else { 
