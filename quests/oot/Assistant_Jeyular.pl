...
sub EVENT_ITEM {
	if(plugin::check_handin(\%itemcount, 14759 => 1 && $phylactory == 1)) {
		# Tome of Miragul
	...
	if(plugin::check_handin(\%itemcount, 5741 => 1 && $phylactory == 2)) {
	...
	if(plugin::check_handin(\%itemcount, 55295 => 1 && $phylactory == 3)) {
	...
	if(plugin::check_handin(\%itemcount, 26744 => 1 && $phylactory == 4)) {
		# Firebone Notebook
	...
	if(plugin::check_handin(\%itemcount, 27930 => 1 && $phylactory == 5)) {
		# Sanguine Tome
	...
	if(plugin::check_handin(\%itemcount, 1117 => 1 && $phylactory == 6)) {
	...
	if(plugin::check_handin(\%itemcount, 55298 => 1)) {
		# Phylactery
	...
	if(plugin::check_handin(\%itemcount, 55299 => 1)) {
		# Dark Phylactery
