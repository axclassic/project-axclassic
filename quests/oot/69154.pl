...
sub EVENT_WAYPOINT {
    ...
    if($event4==1) {
        #Pitch Black Event
        if(((($zonetime >= 1800)&&($zonetime <= 2359))|(($zonetime >= 0)&&($zonetime <= 500)))&&($sirens==71)) {
            quest::unique_spawn(69309,70,0,-9198.0,291.8,1.0,254.9);
        }#Kidd Spawn

        if(((($zonetime >= 1800)&&($zonetime <= 2359))|(($zonetime >= 0)&&($zonetime <= 500)))&&($sirens==98)) {
    ...
    if($sirens==60) {
        ...
        if((($zonetime >= 1800)&&($zonetime <= 2359))||(($zonetime >= 0)&&($zonetime <= 500))) {
            ...
            if($event4==1) {
                #Pitch Black Event
                quest::spawn2(69155,73,0,-10583.5,-3169.6,-19,0.0);
            }
            else {
