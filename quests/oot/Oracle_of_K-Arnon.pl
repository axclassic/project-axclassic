...
sub EVENT_ENTER{ #PC enters what's there depops and repops required level
	...
	if($ulevel <= 50){ 
	quest::depop;	
	quest::spawn2(69044,0,0,$x,$y,$z,$h);	 #This is the level  36 Oracle that's in the database - Changed his respawn time to 2000 so he won't spawn double while you're there..
	}	
}
