...
my $White = quest::saylink("White", 1);
my $pups = quest::saylink("pups", 1);
my $Yellow = quest::saylink("Yellow", 1);
...
if ($text=~/Tomer/i){quest::say("Tomer? I think Seta needs someone to go find him.. Go ask her.");
}
if ($text=~/headbands/i){quest::say("Yes, I give the $White, $Yellow, and $Orange Headbands to our newer members, and Togahn gives out Red, Purple, and Blue Headbands to our elder members.");
}
if ($text=~/white/i){quest::say("That is our training headband.. Beginning students can earn this by slaying four gnoll $pups, and bringing their scalps back to me.");
}
if ($text=~/pups/i){quest::say("Those vile creatures are constantly attacking our city.. and often killing innocent citizens. It is our duty to help defend Qeynos from their vicious raids.");
}
if ($text=~/yellow/i){quest::say("This is awarded to our students for helping clear out the evil that inhabits the old ruins of the Qeynos Hills. Just bring me back three putrid rib bones as proof of your good deeds and turn in your training headband, and then I will give you the yellow headband.");
}
if ($text=~/orange/i){quest::say("This is a difficult award to obtain. The city of Qeynos is, as you know, under constant attack by the gnolls of Blackburrow. The Silent Fist Clan rewards its members who venture deep into this gnoll stronghold and bring swift justice to these vile creatures. Please return two Blackburrow gnoll pelts - make sure they aren't ruined - and a Blackburrow gnoll skin as proof of your noble actions. Also, turn in your yellow headband, and then I shall give you the orange one. Good luck."); }
}
sub EVENT_ITEM { 
