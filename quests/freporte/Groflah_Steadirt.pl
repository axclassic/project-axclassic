...
sub EVENT_ITEM
{
    ...
    if (plugin::check_handin($itemcount{18818} == 1)) {
        ...
        quest::depopall(10141);
        quest::depopall(10158);
        quest::depopall(10165);
        quest::depopall(10156);
        quest::depopall(10157);
        quest::depopall(10160);
        quest::depopall(10163);
        quest::depopall(10164);
        quest::depopall(10179);
        quest::depopall(10186);
        quest::depopall(10063);
        quest::depopall(10147);
        quest::depopall(10172);
        quest::spawn2(10172,0,0,-874,-246,-52,10);
        quest::spawn2(10157,0,0,-855,-236,-52,65);
        quest::spawn2(10158,0,0,-873,-231,-52,130);
        quest::signalwith(10172, 4, 5000);
    }
