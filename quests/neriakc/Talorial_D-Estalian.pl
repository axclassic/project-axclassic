# NPC: Taloria D`Estalian (ID:42020)
#
# Quests:
#   Unholy Silk Armor
#   Unholy Final Task
...
my $Skullcap = quest::saylink("skullcap", 1);
...
my $ready = quest::saylink("ready", 1);
    ...
    if ($text=~/tasks/i) {
        quest::say("If you are willing to gather some $items that are needed for specific halfling hides I can offer you with the resources necessary to fashion your own armor. After you have crafted your armor, I have a $final test for you.");
    }

    if ($text=~/items/i) {
        quest::say("Excellent $name. Please take this Old Enchanted Tailors Kit. It contains magical power that is able to fashion specific components into a magical version of whatever the core material is. If you are a Necromancer you will need to gather halfling hides that have been infused with many different elements that you will collect and combine in this box. Simply tell me what pattern you want and I will present you with the recipe necessary for $Gloves, $Robe, $Trousers, $Sleeves, $Skullcap, $Bracers or $Sandals. I would recommend you fashion your Robe last due to the difficulty and complex nature that is involved with finding the items necessary.");
        quest::summonitem("17244"); # Old Enchanted Box
    }

    if ($text=~/gloves/i) {
        quest::say("If you are interested in making your own Unholy Silk Gloves you will need to gather 3 Matted Halfling Hides, 2 Snake Eggs, 2 Spiderling Silks and a Cask which can be found in town. Once you have collected these items combine them in the Old Enchanted Box to fashion your Infused halfling hide. Please make sure that you have prepared the correct halfling hide before you approach a loom with the pattern I have given you.");
        quest::summonitem("22588"); # Enchanted Gloves Pattern
    }

    if ($text=~/bracers/i) {
        quest::say("To make your own Unholy Silk Bracer you will need to gather 1 Matted Halfling Hide. 1 Deathfist Scouts Scalp and 2 Snake Eggs. Once you have collected these items combine them in the Old Enchanted Box to fashion your Infused halfling hide. Please make sure that you have prepared the correct halfling hide before you approach a loom with the pattern I have given you.");
        quest::summonitem("22584"); # Enchanted Bracer Pattern
    }

    if ($text=~/trousers/i) {
        quest::say("To make your own Unholy Silk Trousers you will need to collect many items in the forest along with a few in town. The halfling hide that you will need along with a pattern to craft together these Trousers will need to be infused with 4 Matted Halfling Hides, 2 Bone Chips, 3 Spiderling Silks and 1 Raw Bamboo. All of these items will be collected in the field with the exception of the Raw Bamboo which can be bought in town. Please make sure that you have prepared the correct halfling hide before you approach a loom with the pattern I have given you.");
        quest::summonitem("22587"); # Enchanted Trousers Pattern
    }

    if ($text=~/sandals/i) {
        quest::say("If you are interested in making your own Unholy Silk Gloves you will need to gather 2 Matted Halfling Hides, 2 Malachites and 2 Fire Beetle Eyes. Once you have collected these items combine them in the Old Enchanted Box to fashion your Infused halfling hide. Please make sure that you have prepared the correct halfling hide before you approach a loom with the pattern I have given you.");
        quest::summonitem("22630"); # Enchanted Slippers Pattern
    }

    if ($text=~/sleeves/i) {
        quest::say("If you wish to fashion together your own Unholy Silk Sleeves you will need to gather 3 Matted Halfling Hides, 1 Fire Beetle Leg, 4 Bone Chips and 2 Bandages. Once you have collected these items combine them in the Old Enchanted Box to fashion your Infused halfling hide. Please make sure that you have prepared the correct halfling hide before you approach a loom with the pattern I have given you.");
        quest::summonitem("22586"); # Enchanted Sleeves Pattern
    }

    if ($text=~/skullcap/i) {
        quest::say("In order to fashion your own Unholy Silk Skullcap you will need to collect a few things and then combine them in the kit I presented you with earlier. Gather 1 Matted Halfling Hide, 2 Deathfist Scouts Scalp and a bottle of Red Wine. After you have done this you will receive an Infused halfling hide. Please make sure that you have prepared the correct halfling hide to be combined with this Skullcap pattern because others will not work. Seek out a loom and reap the rewards of your hard work.");
        quest::summonitem("22583"); # Enchanted Cap Pattern
    }

    if ($text=~/robe/i) {
        quest::say("Your Unholy Silk Robe is your most important and symbolic item you that will be able to craft on your own. I would recommend that you have already gone through the steps of crafting your other pieces before your Robe. If you think that you are ready you will need to collect 4 Matted Halfling Hides, 1 Black Wolf Pelt, 2 Embalming Dusts, 1 Halfling Toe, 1 Bear Meat and 1 Fish Wine. Combine all of these in your box to create the Infused hide. Use this Robe pattern along with your Infused hide on the nearest loom to reap the rewards of your hard work.");
        quest::summonitem("22589"); # Enchanted Robe Pattern
    }
    ...
    if ($text=~/ready/i) {
        ...
        quest::summonitem(17243); # Ancient Book Binding
    }
}
#END of FILE Zone:neriakc  ID:42020 -- Talorial_D`Estalian
