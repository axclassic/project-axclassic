...
my $final = quest::saylink("final", 1);
  ...
  if(($text=~/Cleric/i&&$class eq 'Cleric' && $race eq 'Dark Elf')){ 
  ...
  if(($text=~/interested/i&&$class eq 'Cleric' && $race eq 'Dark Elf')) {
  ...
  if(($text=~/magical/i&&$class eq 'Cleric' && $race eq 'Dark Elf')) {
  ...
  if(($text=~/important/i&&$class eq 'Cleric' && $race eq 'Dark Elf')) {
 ...
 if(($text=~/Greaves/i&&$class eq 'Cleric' && $race eq 'Dark Elf'))  {
  ...
  if(($text=~/final/i&&$class eq 'Cleric' && $race eq 'Dark Elf')){ 
...
if (plugin::check_handin(\%itemcount, 22617 => 1, 22618 => 1, 22619 => 1)) {
    ...
    elsif(($platinum == 1) && plugin::check_handin(\%itemcount, 22601  => 2, 13750 => 1, 16166 => 1)) {
