...
sub EVENT_TIMER {
    if($timer == 1) {
        ...
        quest::signalwith($avatar_of_dread_id, 1, 10);
        SPAWN_RANDOM_WAVE();
        ...
        quest::signalwith($avatar_of_fright_id, 1, 10);
        SPAWN_RANDOM_WAVE();
        ...
        quest::signalwith($avatar_of_terror_id, 1, 10);
        SPAWN_RANDOM_WAVE();
...
sub EVENT_DEATH {
    # signal victory
    quest::signalwith($tahia_felwah_id_2, 1, 10);
