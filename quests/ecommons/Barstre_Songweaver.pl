...
sub EVENT_SAY {
    if($ulevel >= 15) {
        if(defined($qglobals{Wayfarer}) && ($qglobals{Wayfarer} == 1)) {
            #PC has spoken to home town Wayfarer recruiter but not received Adventurer's Stone
            if($text=~/hail/i) {
            ...
            #PC is ready forAdventurer's Stone
                if($client->KeyRingCheck(41000) && !plugin::check_hasitem($client,41000)) {
                    ...
                    if($ruj_wins < 2) {
                    ...
                    elsif ($ruj_wins >= 2 && (!defined($qglobals{RUJtalk}) || ($qglobals{RUJtalk} == 0))) {
                        #2 wins
                    ...
                    elsif ($ruj_wins >= 4 && $qglobals{RUJtalk} == 1) {
                        #4 wins
                    ...
                    elsif ($ruj_wins >= 6 && $qglobals{RUJtalk} == 2) {
                        #6 wins
                    ...
                    elsif ($ruj_wins >= 8 && $qglobals{RUJtalk} == 3) {
                        #8 wins
                    ...
                    elsif ($ruj_wins >= 10 && $qglobals{RUJtalk} == 4) {
                        #10 wins - Power Up
                    ...
                    elsif ($ruj_wins >= 12 && $qglobals{RUJtalk} == 5) {
                        #12 wins
                    ...
                    elsif ($ruj_wins >= 14 && $qglobals{RUJtalk} == 6) {
                        #Send to other NPC
                        $client->Message(13, "You have additional information to uncover! You must speak to Ginehl Wiquar to find out more.");
                    }
                    ...
                    elsif ($ruj_wins >= 24 && $qglobals{RUJtalk} == 11) {
                        #24 wins
                    ...
                    elsif ($ruj_wins >= 26 && $qglobals{RUJtalk} == 12) {
                        #26 wins
                    ...
                    elsif ($ruj_wins >= 28 && $qglobals{RUJtalk} == 13) {
                        #28 wins
                    ...
                    elsif ($ruj_wins >= 30 && $qglobals{RUJtalk} == 14) {
                        #30 wins - Power Up
                    ...
                    elsif ($ruj_wins >= 32 && $qglobals{RUJtalk} == 15) {
                        #32 wins
                    ...
                    elsif ($ruj_wins >= 34 && $qglobals{RUJtalk} == 16) {
                        #34 wins
                    ...
                    elsif ($ruj_wins >= 36 && $qglobals{RUJtalk} == 17) {
                        #36 wins
                    ...
                    elsif ($ruj_wins >= 38 && $qglobals{RUJtalk} == 18) {
                        #38 wins
                    ...
                    elsif ($ruj_wins >= 40 && $qglobals{RUJtalk} == 19) {
                        #40 wins - Power Up
                    ...
                    elsif ($ruj_wins >= 42 && $qglobals{RUJtalk} == 20) {
                        #42 wins
                    ...
                    elsif ($ruj_wins >= 44 && $qglobals{RUJtalk} == 21) {
                        #44 wins
                    ...
                    elsif ($ruj_wins >= 46 && $qglobals{RUJtalk} == 22) {
                        #46 wins
                    ...
                    elsif ($ruj_wins >= 48 && $qglobals{RUJtalk} == 23) {
                        #48 wins
                    ...
                    elsif ($ruj_wins >= 50 && $qglobals{RUJtalk} == 24) {
                        #50 wins - Power Up
                    ...
                    elsif ($ruj_wins >= 52 && $qglobals{RUJtalk} == 25) {
                        #52 wins
                    ...
                    elsif ($ruj_wins >= 54 && $qglobals{RUJtalk} == 26) {
                        #54 wins
                    ...
                    elsif ($ruj_wins >= 56 && $qglobals{RUJtalk} == 27) {
                        #56 wins
                    ...
                    elsif ($ruj_wins >= 58 && $qglobals{RUJtalk} == 28) {
                        #58 wins
                    ...
                    elsif ($ruj_wins >= 60 && $qglobals{RUJtalk} == 29) {
                        #60 wins - Power Up
                    ...
                    elsif ($ruj_wins >= 64 && $qglobals{RUJtalk} == 30) {
                        #Send to other NPC
                        $client->Message(13, "You have additional information to uncover! You must speak to Shumpi Wimahnn to find out more.");
                    }
                        ...
                        $client->Message(15, "You have received an invaluable piece of information!");
                        $client->Message(15, "Your Adventurer Stone glows with more power as you gain stature with the Wayfarers Brotherhood.");
                        if($qglobals{MMCtalk} == 38 && $qglobals{MIRtalk} == 34 && $qglobals{TAKtalk} == 39 && $qglobals{GUKtalk} == 35) {
                            #player has just maxed their stone
        ...
        elsif (defined($qglobals{Wayfarer}) && ($qglobals{Wayfarer} == 4) && !plugin::check_hasitem($client, 40999)) {
            #PC has earned Wayfarers Brotherhood Emblem
            ...
            #PC has not talked to hometown Wayfarer recruiter yet
