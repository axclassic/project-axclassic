...
sub EVENT_ITEM {
    if(plugin::check_handin(\%itemcount, 1667 => 1)) {
    ...
    elsif(($itemcount{1675} == 1) && ($itemcount{1676} == 1) && ($itemcount{1677} == 1)) {
        #Part of Shaman Epic 1.0
    ...
    elsif(($itemcount{1669} == 1) && ($itemcount{1670} == 1)) {
        #Part of Shaman Epic 1.0
    ...
    elsif(plugin::check_handin(\%itemcount, 1669 => 1)) {
        #Part of Shaman Epic 1.0
        quest::say("This is a sad day. You have failed and strayed from the path set before you. Please try to live as close to the spirits as you are able, though this is the closest you will ever get.");
        quest::depop();
    }
    elsif(plugin::check_handin(\%itemcount, 1670 => 1)) {
        #Part of Shaman Epic 1.0
        quest::say("This is a sad day. You have failed and strayed from the path set before you. Please try to live as close to the spirits as you are able, though this is the closest you will ever get.");
        quest::depop();
    }  
