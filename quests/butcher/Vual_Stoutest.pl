        ...
        if(defined($qglobals{Wayfarer}) && ($qglobals{Wayfarer} == 1)) {
            ...
            #PC is ready forAdventurer's Stone
                if(!$client->KeyRingCheck(41000) && !plugin::check_hasitem($client,41000)) {
                    ...
                    if($mmc_wins < 2) {
                    ...
                    elsif ($mmc_wins >= 2 && (!defined($qglobals{MMCtalk}) || ($qglobals{MMCtalk} == 0))) {
                        #2 wins
                    ...
                    elsif ($mmc_wins >= 4 && $qglobals{MMCtalk} == 1) {
                        #4 wins
                    ...
                    elsif ($mmc_wins >= 6 && $qglobals{MMCtalk} == 2) {
                        #6 wins
                    ...
                    elsif ($mmc_wins >= 8 && $qglobals{MMCtalk} == 3) {
                        #8 wins
                    ...
                    elsif ($mmc_wins >= 10 && $qglobals{MMCtalk} == 4) {
                        #10 wins - Power Up
                    ...
                    elsif ($mmc_wins >= 12 && $qglobals{MMCtalk} == 5) {
                        #12 wins
                    ...
                    elsif ($mmc_wins >= 14 && $qglobals{MMCtalk} == 6) {
                        #14 wins
                    ...
                    elsif ($mmc_wins >= 16 && $qglobals{MMCtalk} == 7) {
                        #16 wins
                    ...
                    elsif ($mmc_wins >= 18 && $qglobals{MMCtalk} == 8) {
                        #18 wins
                    ...
                    elsif ($mmc_wins >= 20 && $qglobals{MMCtalk} == 9) {
                        #20 wins - Power Up
                    ...
                    elsif ($mmc_wins >= 22 && $qglobals{MMCtalk} == 10) {
                        #22 wins
                    ...
                    elsif ($mmc_wins >= 24 && $qglobals{MMCtalk} == 11) {
                        #Send to other NPC
                        $client->Message(13, "You have additional information to uncover! You must speak to Henai Silentwalker to find out more.");
                    }
                    ...
                    elsif ($mmc_wins >= 40 && $qglobals{MMCtalk} == 19) {
                        #40 wins - Power Up
                    ...
                    elsif ($mmc_wins >= 42 && $qglobals{MMCtalk} == 20) {
                        #42 wins
                    ...
                    elsif ($mmc_wins >= 44 && $qglobals{MMCtalk} == 21) {
                        #44 wins
                    ...
                    elsif ($mmc_wins >= 46 && $qglobals{MMCtalk} == 22) {
                        #46 wins
                    ...
                    elsif ($mmc_wins >= 48 && $qglobals{MMCtalk} == 23) {
                        #48 wins
                    ...
                    elsif ($mmc_wins >= 50 && $qglobals{MMCtalk} == 24) {
                        #50 wins - Power Up
                    ...
                    elsif ($mmc_wins >= 52 && $qglobals{MMCtalk} == 25) {
                        #Send to other NPC
                        $client->Message(13, "You have additional information to uncover! You must speak to Elwinn Prelliaen too find out more!");
                    }
                    ...
                    elsif ($mmc_wins >= 64 && $qglobals{MMCtalk} == 31) {
                        #64 wins
                    ...
                    elsif ($mmc_wins >= 66 && $qglobals{MMCtalk} == 32) {
                        #66 wins
                    ...
                    elsif ($mmc_wins >= 68 && $qglobals{MMCtalk} == 33) {
                        #68 wins
                    ...
                    elsif ($mmc_wins >= 70 && $qglobals{MMCtalk} == 34) {
                        #70 wins - Power Up
                    ...
                    elsif ($mmc_wins >= 72 && $qglobals{MMCtalk} == 35) {
                        #72 wins
                    ...
                    elsif ($mmc_wins >= 74 && $qglobals{MMCtalk} == 36) {
                        #74 wins
                    ...
                    elsif ($mmc_wins >= 76 && $qglobals{MMCtalk} == 37) {
                        #76 wins - Power Up
                        ...
                        $client->Message(15, "You have received an invaluable piece of information!");
                        $client->Message(15, "Your Adventurer Stone glows with more power as you gain stature with the Wayfarers Brotherhood.");
                        if($qglobals{RUJtalk} == 37 && $qglobals{MIRtalk} == 34 && $qglobals{TAKtalk} == 39 && $qglobals{GUKtalk} == 35) {
