...
if ($text =~/powerful ring/i)
 {
quest::say ("We discovered the [Cloud of Death] device whilst exploring the destroyed city of Chardok, it was found in a secret passage leading off from the Overking's chamber.");
