sub EVENT_SAY {
   ...
   if($text=~/test/i) {
      quest::say("Well then, deliver this report to Ambassador K'rynn in the Ogre city of Oggok. Be careful $name, there are many things between here and Oggok that wont want thid report delivered.");
