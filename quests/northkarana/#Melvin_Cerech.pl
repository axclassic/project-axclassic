...
sub EVENT_SAY {
    if($text=~/hail/i && $ulevel >= 65) {
        quest::say("Howdy $name I am Melvin. How can I help you?");
    }
    elsif($text=~/hail/i && $ulevel < 65) {
        quest::say("I dont think I should talk to you. Laterz!!");
    }
}
...
sub EVENT_ITEM {
    ...
    #Superior White Dragon Scales 119950
        ...
        quest::say("Very good! $name, I reward you with my token of trust to enable you to advance in your quest. I want you to kill the master of time itself. Bring his head and the token I just gave you back to me, now go!! Dont return without these items! ");
    ...
    #Head of Quarm 119953
        ...
        quest::say("Good! Good. I see you have what it takes to complete this quest my friend. I shall send you on your way now. Bring this coin to Helena Kimang. She is an observer. Last time I saw her she was observing in some honorable place in the Plains of Power.");
