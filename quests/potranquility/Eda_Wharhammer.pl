...
sub EVENT_ITEM {
   if($ulevel >=50 && $qglobals{"exchange_warrior"}) {
      if(plugin::check_handin(\%itemcount, 16271 => 1, 17184 => 1 )) {
         ...
         quest::say("There ye go $name, one warrior emblem and one furnace of Ro.");
   ...
   if($ulevel >=50 && $qglobals{"exchange_cleric"}) {
      if(plugin::check_handin(\%itemcount, 16267 => 1, 17184 => 1 )) {
         quest::summonitem(16271);#Cleric Emblem
         quest::summonitem(17184);#Mystical Furnace of Ro
         quest::say("There ye go $name, one cleric emblem and one furnace of Ro.");
	   ...
	   if ($ulevel >=50 && $qglobals{"exchange_paladin"}) { 
	     if(plugin::check_handin(\%itemcount, 16267 => 1, 17184 => 1 )) { 
         quest::summonitem(16269);#Paladin Emblem
         quest::summonitem(17184);#Mystical Furnace of Ro
		 quest::say("There ye go $name, one paladin emblem and one furnace of Ro.");
	   ...
	   if ($ulevel >=50 && $qglobals{"exchange_ranger"}) {  
	      if(plugin::check_handin(\%itemcount, 16267 => 1, 17184 => 1 )) {
	      quest::summonitem(16272);#Ranger Emblem
          quest::summonitem(17184);#Mystical Furnace of Ro
		  quest::say("There ye go $name, one ranger emblem and one furnace of Ro.");
	    ...
	    if ($ulevel >=50 && $qglobals{"exchange_shadowknight"}) { 
	      if(plugin::check_handin(\%itemcount, 16271 => 1, 17184 => 1 )) { 
	      quest::summonitem(16270);#Shadowknight Emblem
          quest::summonitem(17184);#Mystical Furnace of Ro
		  quest::say("There ye go $name, one shadowknight emblem and one furnace of Ro.");
	    ...
	    if ($ulevel >=50 && $qglobals{"exchange_druid"}) { 
          if(plugin::check_handin(\%itemcount, 16271 => 1, 17184 => 1 )) { 
	      quest::summonitem(16276);#Druid Emblem
          quest::summonitem(17185);#Druzzil's Mystical Sewing Kit
		  quest::say("There ye go $name, one druid emblem and one mystical sewing kit.");
	    ...
	    if ($ulevel >=50 && $qglobals{"exchange_monk"}) { 
         if(plugin::check_handin(\%itemcount, 16271 => 1, 17184 => 1 )) { 
	      quest::summonitem(16275);#Monk Emblem
          quest::summonitem(17185);#Druzzil's Mystical Sewing Kit
		  quest::say("There ye go $name, one monk emblem and one mystical sewing kit.");
	    ...
	    if ($ulevel >=50 && $qglobals{"exchange_bard"}) {   
	     if(plugin::check_handin(\%itemcount, 16267 => 1, 17184 => 1 )) { 
	      quest::summonitem(16268);#Bard Emblem
          quest::summonitem(17184);#Mystical Furnace of Ro
		  quest::say("There ye go $name, one bard emblem and one furnace of Ro.");
	    ...
	    if ($ulevel >=50 && $qglobals{"exchange_rogue"}) { 	
         if(plugin::check_handin(\%itemcount, 16267 => 1, 17184 => 1 )) { 
	      quest::summonitem(16273);#Rogue Emblem
          quest::summonitem(17184);#Mystical Furnace of Ro
		  quest::say("There ye go $name, one rogue emblem and one furnace of Ro.");
	    ...
	    if ($ulevel >=50 && $qglobals{"exchange_shaman"}) { 
	      if(plugin::check_handin(\%itemcount, 16267 => 1, 17184 => 1 )) { 
	       quest::summonitem(16274);#Shaman Emblem
           quest::summonitem(17184);#Mystical Furnace of Ro
		   quest::say("There ye go $name, one shaman emblem and one furnace of Ro.");
	    ...
	    if ($ulevel >=50 && $qglobals{"exchange_necromancer"}) { 
          if(plugin::check_handin(\%itemcount, 16267 => 1, 17184 => 1 )) { 
	       quest::summonitem(16278);#Necromancer Emblem
           quest::summonitem(17185);#Druzzil's Mystical Sewing Kit
		   quest::say("There ye go $name, one necromancer emblem and one mystical sewing kit.");
	    ...
	    if ($ulevel >=50 && $qglobals{"exchange_wizard"}) { 
	     if(plugin::check_handin(\%itemcount, 16267 => 1, 17184 => 1 )) { 
	       quest::summonitem(16279);#Wizard Emblem
           quest::summonitem(17185);#Druzzil's Mystical Sewing Kit
		   quest::say("There ye go $name, one wizard emblem and one mystical sewing kit.");
	    ...
	    if ($ulevel >=50 && $qglobals{"exchange_magician"}) { 	
	      if(plugin::check_handin(\%itemcount, 16267 => 1, 17184 => 1 )) { 
	       quest::summonitem(16280);#Magician Emblem
           quest::summonitem(17185);#Druzzil's Mystical Sewing Kit
		   quest::say("There ye go $name, one magician emblem and one mystical sewing kit.");
	    ...
	    if ($ulevel >=50 && $qglobals{"exchange_enchanter"}) { 
	      if(plugin::check_handin(\%itemcount, 16267 => 1, 17184 => 1 )) { 
	        quest::summonitem(16281);#Enchanter Emblem
            quest::summonitem(17185);#Druzzil's Mystical Sewing Kit
			quest::say("There ye go $name, one enchanter emblem and one mystical sewing kit.");
	    ...
	    if ($ulevel >=50 && $qglobals{"exchange_beastlord"}) { 
	      if(plugin::check_handin(\%itemcount, 16267 => 1, 17184 => 1 )) { 
	        quest::summonitem(16277);#Beastlord Emblem
            quest::summonitem(17185);#Druzzil's Mystical Sewing Kit
			quest::say("There ye go $name, one beastlord emblem and one mystical sewing kit.");
	    ...
	    if ($ulevel >=50 && $qglobals{"exchange_berserker"}) { 
	      if(plugin::check_handin(\%itemcount, 16267 => 1, 17184 => 1 )) { 
	        quest::summonitem(32000);#Berserker Emblem
            quest::summonitem(17184);#Mystical Furnace of Ro
			quest::say("There ye go $name, one berserker emblem and one furnace of Ro.");
