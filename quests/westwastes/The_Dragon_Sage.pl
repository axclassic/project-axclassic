sub EVENT_SAY {
 if($text=~/hail/i){
 ...
 elsif($text=~/who are you/i){ #Start of Porlos' Fury Quest
 ...
 elsif($text=~/danger/i){ #Part of Porlos' Fury Quest
 ...
 elsif($text=~/Age of Scale/i){ #Part of Porlos' Fury Quest
 ...
 elsif($text=~/other gods/i){ #Part of Porlos' Fury Quest
 ...
 elsif($text=~/Elder Age/i){ #Part of Porlos' Fury Quest
 ...
 elsif($text=~/observations/i){ #Part of Porlos' Fury Quest
 ...
 elsif($text=~/plant/i){ #Part of Porlos' Fury Quest
  ...
  quest::summonitem('1782'); #a Giant Loyalist Token (1782)
 }
}

sub EVENT_ITEM {
 #Handin: Giant Scalebound Tome (1783)
 if(plugin::check_handin(\%itemcount, 1783 => 1)){ #Part of Porlos' Fury Quest
 ...
 #Handin: Sealed Reagent Box (1786)
 elsif(plugin::check_handin(\%itemcount, 1786 => 1)){ #End of Porlos' Fury Quest
  ...
  quest::summonitem('19469'); #Porlos' Fury (19469)
 } 
 else {
