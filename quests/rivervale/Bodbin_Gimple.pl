...
sub EVENT_SAY {
    if($text=~/Hail/i) {
        $client->Message(14,"Hello $name, I am Bodbin Gimple, the best arms crafter and sharpener in all of Rivervale (atleast thats what they say hehe). Most of the work i do for the guild leaders around here. Anyway young $class, did you have work for me? You can just hand me the items and i see what i can do ...");
    }
}
...
sub EVENT_ITEM {
    ...
    elsif(plugin::check_handin(\%itemcount, 19663 => 1, 19616 => 1)) {
        #Druid handin
