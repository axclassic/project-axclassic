...
sub EVENT_SAY {
  if($text=~/saviour/i) {
    quest::emote(' closes his eyes and bows before you.');
  ...
  if($text=~/yes/i){ #The Penance quest
    quest::emote(' shakes his head and growls.');
	quest::say("That is not good, broodling... Not good at all. You will need to take this note and seek out the Toilmaster immediately. Read it on the way and hope that your incompetence can be overcome. The Crusaders of Greenmist have a pit meant for you, should this prove to be impossible."); #Could not find original text
...
sub EVENT_ITEM {
  ...
  #Shaman Skull Quest No.3.1 turn in - Check for  A froglok hex doll
    ...
    quest::ding(); quest::exp(80000); #give decent xp...
  ...
  #Shaman Skull Quest No.5 turn in - Iksar Skull Helm and Iksar Skull and Cudgel of the Prophet
    ...
    quest::ding(); quest::exp(120000); #give decent xp...
