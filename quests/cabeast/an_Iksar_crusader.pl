...
my $traitor = quest::saylink("traitor", 1);
my $tome = quest::saylink("tome", 1);
my $recipients = quest::saylink("recipients", 1);
my $riders = quest::saylink("riders", 1);
my $ready = quest::saylink("ready", 1);
 if($text=~/hail/i){ #Test of Betrayal (Greenmist Quest 5/8)
 ...
 elsif($text=~/tome/i){ #Test of Betrayal (Greenmist Quest 5/8)
  ...
  quest::emote(' shows signs of fear and his face turns olive.');
  quest::say("I do not know. The spider $riders!! I have only heard tales of them from dying lizards. Evil skinless stubs. From the wounds inflicted on the lizards, I can tell they are vicious opponents. Bloated and frayed flesh, disembowelment. Their steeds must have also joined the fray, for some of the victims were covered in webs.'");
  }
 elsif($text=~/riders/i){ #Test of Betrayal (Greenmist Quest 5/8)
 ...
 elsif($text=~/ready/i){ #Test of Betrayal (Greenmist Quest 5/8)
