...
my $retrieve = quest::saylink("retrieve", 1);
 ...
 elsif($text=~/training/i){ #Test of the Pawn (Greenmist Quest 1/8)
 ...
 elsif($text=~/test/i){ #Test of the Pawn (Greenmist Quest 1/8)
 ...
 elsif($text=~/concern/i){ #Test of Pain (Greenmist Quest 2/8)
 ...
 elsif($text=~/retrieve/i){ #Test of Pain (Greenmist Quest 2/8)
...
sub EVENT_ITEM {
my $concern = quest::saylink("concern", 1);
  ...
  quest::say("Speak with Lord Korzin, he will ask you two questions. Knowing our history would help you with these questions, but I will give you the answers.");
  quest::say("371 AG and Rile will be the answers he is looking for. Go now, you have much to do $name.");
