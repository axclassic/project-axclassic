...
sub EVENT_ITEM {
    if(($ulevel >= 65) && plugin::check_handin(\%itemcount, 119956 => 1)) {
        $client->Message(14,"Hello $name, my sister sent you. Good I was waiting for you. I need your help. I was cursed and trapped in the Twilight zone. Every time I try to escape I am being pulled back in. I havent seen my sister in 10 years. Will you help me break this curse? If I could reassemble the 3 platinum gate coins I would have a shot at breaking the curse. They are very difficult to make though. The elementals here hold gate shards. For every 4 you can bring me I can construct 1 Silver Gate coin. For every 4 Silver Gate Coins I can make 1 Gold Gate Coin. For every 4 Gold Gate Coins I can make 1 Platinum Gate Coin. You need to, all in all, give me the token I am about to give you and 3 Platinum Gate Coins. Hurry up I need to leave this place at once.");
        quest::summonitem("119961");
    }
    elsif(($ulevel >= 65) && plugin::check_handin(\%itemcount, 119957 => 4)) {
        $client->Message(14,"Ok $name , Here is your Silver Gate Coin..");
        quest::summonitem("119958");
    }
    elsif(($ulevel >= 65) && plugin::check_handin(\%itemcount, 119958 => 4)) {
        $client->Message(14,"Ok $name , Here is your Golden Gate Coin..");
        quest::summonitem("119959");
    }
    elsif(($ulevel >= 65) && plugin::check_handin(\%itemcount, 119959 => 4)) {
        $client->Message(14,"Ok $name , Here is your Platinum Gate Coin..");
