...
## UPDATE 2/2/16 Fixed and cleanup  ##
######################################
## Further Notes:
...
##SAYLINKS FIRST!
my $minCharID  = 5829; # 5829 Ladder info
...
my $random_result2 = int(rand(150));
    ...
    if(($ulevel <= 5) && ($random_result2 <= 50) && ($zoneid != 165)) {
...
$npc->DoAnim(8, 48);
	if($text=~/Hail/i) {
        if(($ulevel <= 10) && ($event1 == 1)) {
			$client->Message(14,"Ranger Band says, 'Happy $tevent1 $name, I have $traveled many lands, seen many things, if you're interested, I can tell you of them.'"); }
        elsif($event2 == 1){
			$client->Message(14,"Ranger Band says, 'Happy $tevent2 $name, I have $traveled many lands, seen many things, if you're interested, I can tell you of them.'"); }
		    ...
		    $client->Message(14,"Ranger Band says, 'Merry $tevent6 $name, I have $traveled many lands, seen many things, if you're interested, I can tell you of them.'"); }
		else{ 
...
#Ranger Band Saystuff starts here
	if(($text=~/traveled/i) && ($random_result3 <= 10)){
	  ...
	  $client->Message(14,"Ranger Band says, 'Once I saw a tiny dragon living in a small pool while in The $warrens.'"); }
	  ...
	  $client->Message(14,"Ranger Band says, 'I remember the time we camped for the Tserrina's Robe in $tower.'"); }
	elsif($text=~/tower/i){
