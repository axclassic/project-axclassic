...
sub EVENT_SAY { 
my $text1 = quest::saylink("gloves", 1);
my $text2 = quest::saylink("bracer", 1);
my $text3 = quest::saylink("boots", 1);
my $text4 = quest::saylink("sleeves", 1);
my $text5 = quest::saylink("cap", 1);
my $text6 = quest::saylink("tunic", 1);
	if($text=~/Hail/i) {
	 quest::say("Ah. greetings!  I am Kaza Raj, trainer of young Vah'shir!  Bring me the items I ask and I will reward you with pieces of armor to protect you in your travels.  I have $text1 $text2 $text3 $text4 $text5 or a $text6 available now if you're interested.");
	 }
	if($text=~/gloves/i) {
...
sub EVENT_ITEM {
	if(plugin::check_handin(\%itemcount, 2476 => 4)){#Broken Brigand Skull  x4
		quest::say("Excellent! Here is your Bracer!");
		...
		quest::say("Excellent! Here are your Gloves!");
		...
		quest::say("Excellent! Here are your Boots!");
		...
		quest::say("Excellent! Here are your Sleeves!");
		...
		quest::say("Excellent! Here is your Cap!");
		...
		quest::say("Excellent! Here are your Pants!");
