...
my $g = quest::ChooseRandom(166503,166515,166533,166591);
my $h = quest::ChooseRandom(166504,166516,166592,166593);
my $i = quest::ChooseRandom(166594,166494);
...
if($signal == 600){
  ...
  if($signal == 607){
   ...
   if($signal == 619){    
   quest::spawn2(166565,0,0,1190,2159.2,170.6,185.6); #a_grimling_defender
   }
   if($signal == 620){
   quest::spawn2(166567,0,0,1187.5,2177,173.8,191.5); #a_grimling_defender
   }
   if($signal == 621){
   quest::spawn2(166568,0,0,1186.9,2198.8,178.1,189.8); #a_grimling_defender
   }
   if($signal == 622){
   quest::spawn2(166569,0,0,1195,2139.7,169.7,191.6); #a_grimling_defender
   }
   if($signal == 623){
   quest::spawn2(166570,0,0,1194.6,2117.5,168,194.8); #a_grimling_defender
   }
   if($signal == 624){
   quest::spawn2(166549,0,0,1996.1,3623.3,166.6,124.4); #a_grimling_overseer
   }
   if($signal == 625){
   quest::spawn2(166571,0,0,1318.9,1109.9,115.5,194.1); #a_grimling_defender
   }
   if($signal == 626){
   quest::spawn2(166595,0,0,398,1942,133.1,25.5); #a_grimling_thief
   }
   if($signal == 627){
   ...
   if($signal == 638){
   quest::spawn2(166551,0,0,1975.4,3275.8,159.8,135.4); #a_grimling_overseer
   }
   if($signal == 639){
