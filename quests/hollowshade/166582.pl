...
my $ai = quest::ChooseRandom(166321,166322,166323,166324);
my $aj = quest::ChooseRandom(166325,166326,166327,166328);
my $ak = quest::ChooseRandom(166329,166330,166331,166332);
my $al = quest::ChooseRandom(166333,166334,166335,166336);
my $am = quest::ChooseRandom(166337,166338,166339,166340);
my $an = quest::ChooseRandom(166341,166342,166343,166344);
my $ao = quest::ChooseRandom(166345,166346,166347,166348);
my $ap = quest::ChooseRandom(166349,166350,166351,166352);
my $aq = quest::ChooseRandom(166793,166356);
my $ar = quest::ChooseRandom(166357,166358);
my $as = quest::ChooseRandom(166359,166360,166361);
my $at = quest::ChooseRandom(166362,166363,166364,166365);
my $au = quest::ChooseRandom(166366,166367,166368,166369);
my $av = quest::ChooseRandom(166370,166371,166372);
my $aw = quest::ChooseRandom(166951,166952,166794);
my $ax = quest::ChooseRandom(166375,166376);
...
my $bm = quest::ChooseRandom(166572,166573);
my $bn = quest::ChooseRandom(166506,166517,166536,166548);
my $bo = quest::ChooseRandom(166507,166518,166537);
...
my $cn = quest::ChooseRandom(166747,166302,166748,166749);
