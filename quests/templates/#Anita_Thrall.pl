...
sub EVENT_ITEM {
    ...
    elsif(plugin::check_handin(\%itemcount,28216 => 1)) {
    ...
    elsif(plugin::check_handin(\%itemcount,15003 => 1)) {
        #Summon Corpse
        $client->Message(14,"Excellent, thank you, $class. Your spell has been scribed.");
    ...
    elsif(plugin::check_handin(\%itemcount,19307 => 1)) {
        #Conjure Corpse
        $client->Message(14,"Excellent, thank you, $class. Your spell has been scribed.");
    ...
    ## Check handin
    elsif(plugin::check_handin(\%itemcount,15676 => 1)) {
        #Tashan
        $client->Message(14,"Excellent, thank you, $class. Your spell has been scribed.");
    ...
    elsif(plugin::check_handin(\%itemcount,15677 => 1)) {
        #Tashani
        $client->Message(14,"Excellent, thank you, $class. Your spell has been scribed.");
    ...
    elsif(plugin::check_handin(\%itemcount,15678 => 1)) {
        #Tashania
        $client->Message(14,"Excellent, thank you, $class. Your spell has been scribed.");
    ...
    elsif(plugin::check_handin(\%itemcount,19394 => 1)) {
        #Tashanian
        $client->Message(14,"Excellent, thank you, $class. Your spell has been scribed.");
    ...
    elsif(plugin::check_handin(\%itemcount,28452 => 1)) {
        #Howl of Tashan
        $client->Message(14,"Excellent, thank you, $class. Your spell has been scribed.");
    ...
    elsif(plugin::check_handin(\%itemcount,78945 => 1)) {
        #Echo of Tashan
        $client->Message(14,"Excellent, thank you, $class. Your spell has been scribed.");
    ...
    elsif(plugin::check_handin(\%itemcount,19387 => 1)) {
        #Wind of Tashani
        $client->Message(14,"Excellent, thank you, $class. Your spell has been scribed.");
    ...
    elsif(plugin::check_handin(\%itemcount,19405 => 1)) {
        #Wind of Tashanian
        $client->Message(14,"Excellent, thank you, $class. Your spell has been scribed.");
    ...
    elsif(plugin::check_handin(\%itemcount,59011 => 1)) {
        #Temperance
        $client->Message(14,"Excellent, thank you, $class. Your spell has been scribed.");
    ...
    elsif(plugin::check_handin(\%itemcount,59572 => 1)) {
    ...
    ## Circle Spells
        ...
        #Don't turn in both stones at the same time!
    ...
    elsif(($itemcount{135} == 1) && ($itemcount{136} == 1)) {
        #Don't turn in both stones at the same time!
        $client->Message(14,"The Moonstones must be given to me one at a time.");
        $client->Message(6,"You failed to scribe your spells!");
    ...
    elsif(($itemcount{131} == 1) && ($itemcount{132} == 1)) {
        #Don't turn in both stones at the same time!
        $client->Message(14,"The Moonstones must be given to me one at a time.");
        $client->Message(6,"You failed to scribe your spells!");
    ...
    elsif(($ulevel>=50) && ($itemcount{30438} == 1) && ($itemcount{30398} == 1) && ($itemcount{30440} == 1)&& ($itemcount{77662} == 1) && ($bot_spell_2 == 3)) {
    ...
    elsif(($ulevel>=50) && ($itemcount{30438} == 1) && ($itemcount{30398} == 1) && ($itemcount{30440} == 1)&& ($itemcount{77662} == 1) && ($bot_spell_2 == 0)) {
    ...
    elsif(($ulevel>=50) && ($itemcount{30438} == 1) && ($itemcount{30398} == 1) && ($itemcount{30440} == 1)&& ($itemcount{77662} == 1) && ($bot_spell_2 == 1)) {
        $client->Message(6,"You have scribed the spell Circle of Misty!");
        $client->Message(6,"You have scribed the spell Circle of The Great Divide!"); #19516
        $client->Message(6,"You have scribed the spell Circle of Wakening Lands!"); #30398
        $client->Message(6,"You have scribed the spell Circle of Knowledge!");
    ...
    elsif(($ulevel>=50) && ($itemcount{30438} == 1) && ($itemcount{30398} == 1) && ($itemcount{30440} == 1)&& ($itemcount{77662} == 1) && ($bot_spell_2 == 2)) {
        $client->Message(6,"You have scribed the spell Circle of Slaughter!");
        $client->Message(6,"You have scribed the spell Circle of Bloodfields!"); #77662
        $client->Message(14,"Excellent, thank you, $class. Your Bots' Circle spells have been scribed.");
        quest::summonitem(129);
    ...
    elsif(plugin::check_handin(\%itemcount,129 => 1)) {
        #Lesser Moonstone of Circles forthe spell scriber
        $client->Message(6,"You have scribed the spell Circle of Karana!");
        $client->Message(6,"You have scribed the spell Circle of Commons!");
        $client->Message(6,"You have scribed the spell Circle of Toxxulia!");
        $client->Message(6,"You have scribed the spell Circle of Butcherblock!");
    ...
    elsif(plugin::check_handin(\%itemcount,135 => 1)) {
        #Moonstone of Circles forthe spell scriber
        $client->Message(6,"You have scribed the spell Circle of Misty!");
        $client->Message(6,"You have scribed the spell Circle of The Great Divide!"); #19516
        $client->Message(6,"You have scribed the spell Circle of Wakening Lands!"); #30398
        $client->Message(6,"You have scribed the spell Circle of Knowledge!");
    ...
    elsif(plugin::check_handin(\%itemcount,131 => 1)) {
        #Greater Moonstone of Circles forthe spell scriber
        $client->Message(6,"You have scribed the spell Circle of Slaughter!");
        $client->Message(6,"You have scribed the spell Circle of Bloodfields!"); #77662
    ...
    ## Portal Spells
    elsif(($ulevel>=50) && ($itemcount{30399} == 1) && ($itemcount{30423} == 1)&& ($itemcount{30425} == 1)&&($itemcount{77661} == 1) && ($bot_spell_3 == 3)) {
        $client->Message(14,"You already have all these needed spells scribed.");
        quest::summonitem(130);
    ...
    elsif(($ulevel>=50) && ($itemcount{30399} == 1) && ($itemcount{30423} == 1)&& ($itemcount{30425} == 1)&&($itemcount{77661} == 1) && ($bot_spell_3 == 0)) {
    ...
    elsif(($ulevel>=50) && ($itemcount{30399} == 1) && ($itemcount{30423} == 1)&& ($itemcount{30425} == 1)&&($itemcount{77661} == 1) && ($bot_spell_3 == 1)) {
        $client->Message(6,"You have scribed the spell Twilight Portal!");
        $client->Message(6,"You have scribed the spell Iceclad Ocean Portal!");
        $client->Message(6,"You have scribed the spell Commons Portal!");
        $client->Message(6,"You have scribed the spell Wakening Lands Portal!"); #30399
    ...
    elsif(plugin::check_handin(\%itemcount,130 => 1)) {
        #Lesser Moonstone of Portals forthe spell scriber
        $client->Message(6,"You have scribed the spell Fay Portal!");
        $client->Message(6,"You have scribed the spell Ro Portal!");
        $client->Message(6,"You have scribed the spell Toxxula Portal!");
        $client->Message(6,"You have scribed the spell North Karana Portal!");
    ...
    elsif(plugin::check_handin(\%itemcount,136 => 1)) {
        #Moonstone of Portals forthe spell scriber
        $client->Message(6,"You have scribed the spell Twilight Portal!");
        $client->Message(6,"You have scribed the spell Iceclad Ocean Portal!");
        $client->Message(6,"You have scribed the spell Commons Portal!");
        $client->Message(6,"You have scribed the spell Wakening Lands Portal!"); #30399
    ...
    elsif(plugin::check_handin(\%itemcount,132 => 1)) {
        #Greater Moonstone of Portals forthe spell scriber
        $client->Message(6,"You have scribed the spell Wall of Slaughter Portal!");
        $client->Message(6,"You have scribed the spell Bloodfields Portal!"); # 77661
