...
sub EVENT_ITEM {
    if((plugin::check_handin(\%itemcount, 1246 => 1)) ||
       ...
       (plugin::check_handin(\%itemcount, 1252 => 1))) {
        #Insidious Armor, the comments on Alla's about this not being taken are in error, I believe.  It's Fine Insidious that's not taken.
