...
sub EVENT_ITEM {
    if(plugin::check_handin(\%itemcount, 10138 => 1)) {
    ...
    elsif(plugin::check_handin(\%itemcount, 27282 => 1)) {
    ...
    elsif(plugin::check_handin(\%itemcount, 16759 => 1)) {
        #A Protected Tome
    ...
    elsif(plugin::check_handin(\%itemcount, 9834 => 1)) {
    ...
    elsif(plugin::check_handin(\%itemcount, 13620 => 1)) {
    ...
    elsif(plugin::check_handin(\%itemcount, 24630 => 1)) {
