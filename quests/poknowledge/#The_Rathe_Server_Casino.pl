    ...
    if(plugin::check_handin(\%itemcount, 59970 => 1)) {
        ...
        if($random_lot < 750) {
            ...
            ####begin item win 51 tm 65#################################################
                ...
                quest::summonitem(25201);
            } #Velium Encrusted Gauntlets
            elsif($win_win == 53) {
                quest::summonitem(25209);
            } #Helmet of Rallos Zek
            elsif($win_win == 54) {
                quest::summonitem(68698);
            } #Trusik Cloak of Carnage
            elsif($win_win == 55) {
                quest::summonitem(14730);
            } #Circlet of Shadow
            elsif($win_win == 56) {
                quest::summonitem(50187);
            } #Elaborate Defiant Breastplate
            elsif($win_win == 57) {
                quest::summonitem(119499);
            } #Stone of the Dark Elf
            elsif($win_win == 58) {
                quest::summonitem(119667);
            } #Stone of the Gnome
            elsif($win_win == 59) {
                quest::summonitem(131);
            } #Greater Moonstone of Circles
            elsif($win_win == 60) {
                quest::summonitem(132);
            } #Greater Moonstone of Portals
            elsif($win_win == 61) {
                quest::summonitem(614);
