...
sub EVENT_ITEM {
	if(plugin::check_handin(\%itemcount, 28278 => 1)) {
		...
		quest::say("Seal those things up in the container that I just gave you and bring it straight back to me. I'll wait here for you and see if I can decipher anymore of this schematic.");
	}
