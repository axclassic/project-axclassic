...
sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 29112 => 1)) {#Ethereal Parchment
    ...
    quest::summonitem(quest::ChooseRandom(28487, 28488, 28489, 28490, 26945, 21660, 21661, 28491, 28492, 28493, 28494, 28523)); #Level 61 or 62 Shaman spell, PoP (True Spirit, Agility of the Wrulan, Spear of Torment, Cloud of Grummus, Greater Immobilize, Tnarg's Mending, Focus of Soul, Ancestral Guard, Endurance of the Boar, Talisman of the Wrulan, Talisman of the Tribunal, Replenishment)
  }
