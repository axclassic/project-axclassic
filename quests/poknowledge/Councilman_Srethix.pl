...
sub EVENT_ITEM {
	if(plugin::check_handin(\%itemcount, 28741 => 1)) {
	...
	elsif (plugin::check_handin(\%itemcount, 28742 => 1)) {
	...
	elsif (plugin::check_handin(\%itemcount, 28746 => 1)) {
		#Tome of Dark Power
