...
sub EVENT_SAY {
    ...
    if($text=~/hail/i && $ulevel >= 65) {
        $client->Message(14,"Hello $name , I am Melissa Ravenheart the famous Magician. Please tell me that you heard of me in the past. I can $send you on your $prestige quest if you like.");
    }
    ...
    if($text=~/prestige/i && $ulevel >= 65) {
        $client->Message(14,"The Rathe Prestige quest is a very very hard quest (mega epic style) for what could very well be THE most powerfull item in the game. I won\'t tell you what the reward is but I can tell you that you absolutely want to do this quest $name.");
    }
