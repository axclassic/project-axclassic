...
sub EVENT_ITEM {
    if(plugin::check_handin(\%itemcount, 15978 => 1)) {
        #Merchant's Crate of Supplies--I'm not sure this is the correct item, but Cavedude said roll with it, so I'm rollin.
        ...
        quest::ding(); quest::exp(1029000);#2% of level 36 exp...yeah, xp was nerfed on live.
