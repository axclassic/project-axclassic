...
my $no = quest::saylink("no", 1);
     if (plugin::check_handin(\%itemcount, 36003 => 1)) {
        ...
        quest::say("Now before ye take off on some fool quest and get yerself killed, take this tunic -- its not much, but it will keep yer bones from freezing and give you a wee bit o' protection.");
