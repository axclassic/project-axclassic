...
my $Sylen = quest::saylink("Sylen", 1);
my $trace = quest::saylink("trace", 1);
  if ($text=~/hail/i) {
      quest::say("Before I tell you anything, I require you to help me. Seek a woman named Challice. Give her this ring and then return to me.");
...
my $story = quest::saylink("story", 1);
  ...
  elsif(plugin::check_handin(\%itemcount, 14337 => 1, 14338 => 1, 14339 => 1)) {
