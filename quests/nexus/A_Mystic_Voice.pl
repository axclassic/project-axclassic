sub EVENT_SPAWN {
   ...
   quest::signalwith(152000,20,3000);
}
...
sub EVENT_TIMER {
   if($timer eq "nexus2min") {
      ...
      quest::signalwith(152000,21,3000);
   }
   if($timer eq "velious2min") {
      ...
      quest::signalwith(152000,22,3000);
   }
   if($timer eq "velious1min") {
      ...
      quest::signalwith(152000,23,3000);
   }
   if($timer eq "ports2min") {
      ...
      quest::signalwith(152000,24,3000);
   }
   if($timer eq "nexustimer") {
      ...
      quest::signalwith(152000,25,3000);
   }
