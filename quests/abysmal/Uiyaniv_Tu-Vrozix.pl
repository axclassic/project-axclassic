...
sub EVENT_SAY {
    if($text=~/hail/i) {
        if(quest::istaskactivityactive(198,4)) {
            #Poisonmaking Freebie Step 5
            ...
            $client->LearnRecipe(2865); #Muramite Blood Distillate
            $client->LearnRecipe(7384); #Muramite Bile
            quest::updatetaskactivity(198,4,1);
        }
        else {
    ...
    if($text=~/useful/i) {
        ...
        quest::taskselector(198); #Poisonmaking Freebie
    }
    if($text=~/painful tasks/i) {
        if(quest::istaskactivityactive(198,0)) {
            #Poisonmaking Freebie Step 1
        ...
        if(quest::istaskactivityactive(198,1)) {
            #Poisonmaking Freebie Step 2
        ...
        if(quest::istaskactivityactive(198,2)) {
            #Poisonmaking Freebie Step 3
        ...
        if(quest::istaskactivityactive(198,3)) {
            #Poisonmaking Freebie Step 4
...
sub EVENT_ITEM {
    ...
    elsif(plugin::check_handin(\%itemcount, 58130 => 4) || plugin::check_handin(\%itemcount, 58130 => 3) || plugin::check_handin(\%itemcount, 58130 => 2) || plugin::check_handin(\%itemcount, 58130 => 1)) {
        #Simple Universal Suspension
        quest::say("Ah, yes. Thank you.");
    }
    elsif(plugin::check_handin(\%itemcount, 58122 => 4) || plugin::check_handin(\%itemcount, 58122 => 3) || plugin::check_handin(\%itemcount, 58122 => 2) || plugin::check_handin(\%itemcount, 58122 => 1)) {
        #Simple Solvent
        quest::say("Ah, yes. Thank you.");
    }
    elsif(plugin::check_handin(\%itemcount, 58093 => 4) || plugin::check_handin(\%itemcount, 58093 => 3) || plugin::check_handin(\%itemcount, 58093 => 2) || plugin::check_handin(\%itemcount, 58093 => 1)) {
        #Simple Contact Poison
        quest::say("Ah, yes. Thank you.");
    }
    elsif(plugin::check_handin(\%itemcount, 58097 => 4) || plugin::check_handin(\%itemcount, 58097 => 3) || plugin::check_handin(\%itemcount, 58097 => 2) || plugin::check_handin(\%itemcount, 58097 => 1)) {
        #Simple Injected Poison
        quest::say("Ah, yes. Thank you.");
    }
