...
my $warbeads = quest::saylink("warbeads", 1);
if($text=~/Hail/i){
...
if($text=~/recipes/i){
quest::say("I have the material recipes available for Songweavers Platemail $Helm. $Bracers. $Armguards. $Boots. $Greaves. $Gauntlets and $Breastplate. When you are ready to craft a specific piece simply tell me what armor piece you want to craft. Also please keep in mind that the components necessary for crafting your breastplate material are the most difficult to collect so you might want to collect them last.");
}
if($text=~/Armguards/i){
