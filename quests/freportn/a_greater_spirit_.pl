...
#Edited by Aardil added hyper-links 12-6-2013
sub EVENT_SAY {
my $true = quest::saylink("true", 1);
my $trust = quest::saylink("trust", 1);
my $few = quest::saylink("few", 1);
my $Heyokah = quest::saylink("Heyokah", 1);
my $wisps = quest::saylink("wisps", 1);
my $honor = quest::saylink("honor", 1);
my $trust = quest::saylink("trust", 1);
...
my $path = quest::saylink("path", 1);
 if($text=~/hail/i){ #Part of Shaman Epic 1.0
  quest::say("It is good to see you, $name. We're glad you trusted in our brother and did what was asked regardless of Bondl's intentions. This fills us with great joy, as the $true spirits work in ways most people do not understand and $trust is the first lesson of the Heyokah.");
  }
 elsif($text=~/true/i){ #Part of Shaman Epic 1.0
  quest::say("As a shaman , spirits are known to you. They aid you if you pay them homage and respect the world around you. They also will bend to your will if you are powerful enough. We are part of the entire universe and we exist because people believe and feel us. However very $few know us in this form. To mortals we are but ideas, $wisps of consciousness in an expanse of emptiness and as difficult to grasp as breathe in Everfrost.");
  }
 elsif($text=~/few/i){ #Part of Shaman Epic 1.0
 ...
 elsif($text=~/wisps/i){ #Part of Shaman Epic 1.0
  ...
  elsif($text=~/path/i){ #Part of Shaman Epic 1.0
