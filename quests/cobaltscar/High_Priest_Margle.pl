...
my $challenge = quest::saylink("challenge", 1);
	...
	quest::say("Do I know you? You must be lost. Go away stranger, I have nothing for you.");
	}
    elsif($text=~/Water/i && defined $qglobals{"EpicBox"} == 1) {
	...
	elsif($text=~/challenge/i && defined $qglobals{"EpicBox"} == 1) {
