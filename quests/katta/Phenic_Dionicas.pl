...
sub EVENT_ITEM{
	if(plugin::check_handin(\%itemcount, 18330 => 1)){
		...
		quest::faction(284, -1); # Faction: Seru
		quest::faction(142, -1); # Faction: Heart of Seru
		...
		quest::faction(284,-1); # Faction: Seru
		quest::faction(142,-2); # Faction: Heart of Seru
		...
		quest::faction(284,-2); # Faction: Seru
		quest::faction(142,-12); # Faction: Heart of Seru
		...
		if(plugin::check_handin(\%itemcount, 7397 => 1, 31757 => 1, 7394 => 1)) {
			...
			quest::faction(284,-5); # Faction: Seru
			quest::faction(142,-25); # Faction: Heart of Seru
			quest::exp(1000000);
