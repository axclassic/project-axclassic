...
my $ask = quest::saylink("ask", 1);
 ...
 quest::say("You only need to $ask and I will send you to the broodlands entrance.");
 quest::movepc(337,-1613,-1016,99); #Broodlands entrance
...
#quest::say("Well done $name, you may enter the Broodlands."); 
#quest::faction(2789,120);
#uest::summonitem(50003);  #returns Epic
#quest::movepc(337,-1613,-1016,99); #Broodlands entrance
#} 
...
#uest::say("Well done $name, you may enter the Broodlands.");
#quest::faction(2789,120);
#uest::summonitem(60321);  #returns Epic
#quest::movepc(337,-1613,-1016,99); #Broodlands entrance
#} 
