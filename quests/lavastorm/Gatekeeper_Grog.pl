...
my $join = quest::saylink("join", 1);
 ...
 quest::say("If'n youse are willing to $join the Dark Reign I will send youse to the Dark Reign camp in the Broodlands.");
 }
 if($text=~/join/i) {
 quest::say("very well $name, You may pass.");
 quest::movepc(337,-413.4,1120.5,6.2); #Broodlands Dark Reign Camp
  } 
 }
#sub EVENT_ITEM {
...
#quest::say("Dats Gud enough fer me explorer, you kin go to da Broodlands.");
#quest::faction(2789,120)#;
#quest::summonitem(119477);  #returns Epi#c
#quest::movepc(337,-413.4,1120.5,6.2); #Broodlands Dark Reign Camp#
#} 
