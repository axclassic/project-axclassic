...
sub EVENT_SAY {
  ...
  my $help = quest::saylink("help", 1);
   ...
   if ($text=~/Hail/i) {
    ...
    quest::say("I have heard rumors that my wayward brothers have recruited guards to protect them but I question their loyalty to the Evil Bunny. I am sure they wont give the Easter Eggs up without a fight. I need the Easter Eggs back so I can try and correct this issue before its too late. Will you $help?");
	}
   elsif ($text=~/help/i && $ulevel <= 49) {
   quest::assigntask(188);
