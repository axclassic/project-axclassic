...
sub EVENT_SAY {
    ...
    my $deal = quest::saylink("deal with", 1);
    my $work = quest::saylink("work", 1);
    my $more = quest::saylink("more", 1);
    my $interesting = quest::saylink("interesting ore", 1);
