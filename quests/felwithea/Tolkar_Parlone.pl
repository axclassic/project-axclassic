...
sub EVENT_SAY {
    my $daughter = quest::saylink("daughter", 1);
    if($text=~/Hail/i) {
        ...
        quest::say("My daughter's name is Linara.  I have not seen her in several months. and I fear the worst.  She went off adventuring. even though I told her how dangerous it was.");
    }
}
