...
if ($text=~/Code of Zan Fi/i){quest::say("The tome called the Code of the Whistling Fist has been stolen from me. It contains many secrets pertaining to our brotherhood. Thankfully it is magically locked and only a Zan Fi master could unlock it. I quest for a monk to retrieve it. Would you be an [interested monk].");
}
if ($text=~/interested monk/i){quest::say("Then venture into the depths beyond the great Solusek Mining Company. There, living among the Kobolds, will be Targin the Rock. Get the book from him and return here and wait for my reappearance. When we meet again you shall hand me the book and a Purple Headband earned from the Silent Fist Clan. Do so and you shall be closer to joining the brotherhood.");
}
if ($text=~/Brother Zephyl/i){quest::say("Brother Zephyl is searching for one who can return the [Idol of Zan Fi]. I believe he is within the vicinity of the Rathe Mountains.");
}
if ($text=~/Idol of Zan Fi/i){quest::say("The Idol of Zan Fi is a sacred totem to our brotherhood. I cannot share it's secrets, but I can tell you that [Brother Zephyl] will offer to you a reward for it's return.");
}
