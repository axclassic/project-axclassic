...
sub EVENT_SAY {
  ...
  if ($text=~/conception/i) { #wizard test of conception
    quest::say("Conception is vital. Travel beyond and bring forth an Efreeti Statuette, a Mithril Air Ring, and a Box of Winds. From these I will produce a ring that will protect you wherever you go.");
    }
  if ($text=~/visualization/i) { #wizard test of visualization
    quest::say("Visualize and succeed. Proceed upward and bring me a White-Tipped Spiroc Feather, a Pulsating Sapphire, and an Amethyst Amulet. With these items, I will be able to produce an amulet that will aid in your travels to our home.");
    }
