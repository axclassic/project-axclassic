#Note--All text is COMPLETELY wrong, and some faction hits are likely missing.  But, it's a template, and it gets you the important item--a key to Jaled-Dar's Tomb so that you may get your sleeper key.
#Fix this please.
