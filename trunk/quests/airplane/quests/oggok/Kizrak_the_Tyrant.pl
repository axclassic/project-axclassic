sub EVENT_SAY { 
  ...
  if($text=~/Kizrak the Tyrant/i){
    quest::emote("sniffs once, his eyes blaring with impatience as he drums his large fingers on the hilt of the sword at his side.");
    quest::say("I am Kizrak the Tyrant, mighty warrior of Zek, and now champion of The Warlord. Once I brought fear and destruction to any whom would stand in the path of the Ogre nation, but now, they are all [sniveling fools] who cannot find their backside with both of their hands."); 
  }  
}
