...
if($text =~/Hail/i) {
	...
	$client->Message(14,"Excellent news, I was afraid I would not be able to find someone willing to help. Please bring me the master key along with 2 Orc Eyes and I shall craft you a long sword worthy of your great deeds.");
	 ...
	 $client->Message(14,"I don't understand...");
     return 1;
	}
}

sub EVENT_ITEM {
	 if(plugin::check_handin(\%itemcount, 13266 => 2, 27539 => 1)) {
	 ...
	 elsif(($platinum == 1) && plugin::check_handin(\%itemcount, 19697 => 2, 1013 => 1, 27410 => 1) ||
	 ...
	 elsif(($platinum == 1) && plugin::check_handin(\%itemcount, 19697 => 1, 1021 => 1, 9130 => 1) ||
	 ...
	 elsif(($platinum == 1) && plugin::check_handin(\%itemcount, 19697 =>2, 1020 => 1, 13145 => 1) ||
	 ...
	 elsif(($platinum == 1) && plugin::check_handin(\%itemcount, 19697 => 2, 1024 => 1, 13791 => 1) ||
	 ...
	 elsif(($platinum == 1) && plugin::check_handin(\%itemcount, 19697 => 2, 1023 => 1, 16170 => 1) || 
	 ...
	 elsif(($platinum == 1) && plugin::check_handin(\%itemcount, 19697 => 2, 1022 => 1, 20272 => 1) ||
  	 ...
  	 elsif(($platinum == 2) && plugin::check_handin(\%itemcount, 19697 => 2, 1018 => 1, 14018 => 1) || 
