...
# DATABASE: AX-Classic r43 (SVN)
# LAST EDIT DATE: May 29,2009
# VERSION: 1.1
# BASE QUEST BY: PEQ Quest Team
# DEVELOPER: Asram
# Reason for Last Edit: Removed extraneous words from parsing to match keywords in text
#
# *** NPC INFORMATION ***
#
# NAME: Klom_jysun
