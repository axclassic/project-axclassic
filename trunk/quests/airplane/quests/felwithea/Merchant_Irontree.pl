...
sub EVENT_SAY {
my $mithril = quest::saylink("mithril plate");
my $woodlanders = quest::saylink("woodlanders shields");

 
if($text=~/Hail/i){
quest::say("Well met. $name! I am a master craftsman of both steel and $mithril armors. I am also the creator of the $woodlanders. light shields perfect for those who spend much time under the canopy of the All Mothers forests.");
}
