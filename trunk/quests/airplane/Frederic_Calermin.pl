...
sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 20931 => 1, 20754 => 1, 20755 => 1)) { #magician test of clarification using crimson tessera, ethereal sapphire, feathered cape
    quest::summonitem(1274); #bracelet of clarification
     quest::ding(); 
     quest::exp(841790);
    quest::say("Take this as your reward. I trust we're clear now.");
    quest::depop();
    }
    ...
    quest::summonitem(2707); #mask of empowerment
     quest::ding(); 
     quest::exp(841790);
    quest::say("Take this as your reward and feel its power!");
    quest::depop();
    }
    ...
    quest::summonitem(11650); #Staff of the Magister
     quest::ding(); 
     quest::exp(841790);
    quest::say("Wave your hands as you take this as your reward.");
    quest::depop();
    }
    ...
    quest::summonitem(14557); #gold white pendant
     quest::ding(); 
     quest::exp(841790);
    quest::say("I trust you already know to avert your eyes when you take this as your reward.");
    quest::depop();
    }
  else {
