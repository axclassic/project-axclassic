...
sub EVENT_SAY {
  ...
  if ($text=~/test of the wolf/i) { #druid test of the wolf
    quest::say("So you wish the test of The Wolf, do you $name? Go forth unto the islands and find an Azure Tessera, Black Face Paint and finally a Worn Leather Mask. Bring them back to me, but not until you have all three. You shall then be rewarded.");
    }
