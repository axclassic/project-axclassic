...
######################
 ...
 sub EVENT_SAY {
 if(($text=~/I am a berserker and I am ready/i) && (plugin::check_hasitem($client, 60210)) && ($stage == 0)) {
 quest::stoptimer(1);
 ...
 quest::spawn2(79128,78,0,$x,$y,$z,0); #Raving Goblinmaster - Quest
 quest::signalwith(79128,3,0); #Tell Raving Goblinmaster to begin stage 1
 quest::depop();
 }
 }
 ...
 quest::stoptimer(1);
 quest::stoptimer(2);
 quest::spawn2(79128,79,0,$x,$y,$z,0);
 quest::spawn2(79130,0,0,($x + 5),($y + 5),$z,0); #a frantic goblin
 quest::spawn2(79130,0,0,($x + 5),($y - 5),$z,0); #a frantic goblin
 quest::spawn2(79130,0,0,($x - 5),($y + 5),$z,0); #a frantic goblin
 quest::spawn2(79130,0,0,($x - 5),($y - 5),$z,0); #a frantic goblin
 quest::spawn2(79130,0,0,$x,($y + 5),$z,0); #a frantic goblin
 quest::signalwith(79128,4,0); #Tell Raving Goblinmaster to begin stage 2
 quest::depop();
 }
 if(($timer == 1) && ($x == 55) && ($y == 1762) && ($stage == 2)) {
 quest::stoptimer(1);
 quest::stoptimer(2);
 quest::spawn2(79128,80,0,$x,$y,$z,0);
 quest::spawn2(79130,0,0,($x + 5),($y + 5),$z,0); #a frantic goblin
 quest::spawn2(79130,0,0,($x + 5),($y - 5),$z,0); #a frantic goblin
 quest::spawn2(79130,0,0,($x - 5),($y + 5),$z,0); #a frantic goblin
 quest::spawn2(79130,0,0,($x - 5),($y - 5),$z,0); #a frantic goblin
 quest::spawn2(79130,0,0,$x,($y + 5),$z,0); #a frantic goblin
 quest::signalwith(79128,5,0); #Tell Raving Goblinmaster to begin stage 3
 quest::depop();
 }
 if(($timer == 1) && ($x == 262) && ($y == 2105) && ($stage == 3)) {
 quest::stoptimer(1);
 quest::stoptimer(2);
 quest::spawn2(79128,81,0,$x,$y,$z,0);
 quest::spawn2(79130,0,0,($x + 5),($y + 5),$z,0); #a frantic goblin
 quest::spawn2(79130,0,0,($x + 5),($y - 5),$z,0); #a frantic goblin
 quest::spawn2(79130,0,0,($x - 5),($y + 5),$z,0); #a frantic goblin
 quest::spawn2(79130,0,0,($x - 5),($y - 5),$z,0); #a frantic goblin
 quest::spawn2(79130,0,0,$x,($y + 5),$z,0); #a frantic goblin
 quest::signalwith(79128,6,0); #Tell Raving Goblinmaster to begin stage 4
 quest::depop();
 }
 if(($timer == 1) && ($x == 377) && ($y == 2391) && ($stage == 4)) {
 quest::stoptimer(1);
 quest::stoptimer(2);
 quest::spawn2(79128,82,0,$x,$y,$z,0);
 quest::spawn2(79131,0,0,($x + 5),($y + 5),$z,0); #Ferocious Goblin
 quest::spawn2(79131,0,0,($x + 5),($y - 5),$z,0); #Ferocious Goblin
 quest::spawn2(79131,0,0,($x - 5),($y + 5),$z,0); #Ferocious Goblin
 quest::signalwith(79128,7,0); #Tell Raving Goblinmaster to begin stage 5
 quest::depop();
 }
 ...
 quest::signalwith(79128,$stage+3,0);
 }
 if(($goblin == 3) && ($stage == 4)) {
 quest::signalwith(79128,7,0);
 }
 }
