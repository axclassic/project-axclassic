...
sub EVENT_ITEM {
   if ($ulevel == 21 && plugin::check_handin(\%itemcount, 120152 => 1)) { 
    quest::say("So, Greed got the better of him eh? Lets hope he has learned his lesson.");
    quest::ding();
	quest::exp(126100);
    quest::givecash(0,0,0,30);
	}
    elsif ($ulevel == 22 && plugin::check_handin(\%itemcount, 120152 => 1)) {
	quest::say("So, Greed got the better of him eh? Lets hope he has learned his lesson.");
    quest::ding();
	quest::exp(138700);
    quest::givecash(0,0,0,30);
	}
	elsif ($ulevel == 23 && plugin::check_handin(\%itemcount, 120152 => 1)) {
	quest::say("So, Greed got the better of him eh? Lets hope he has learned his lesson.");
    quest::ding();
	quest::exp(151900);
    quest::givecash(0,0,0,30);
	}
	elsif ($ulevel == 24 && plugin::check_handin(\%itemcount, 120152 => 1)) {
	quest::say("So, Greed got the better of him eh? Lets hope he has learned his lesson.");
    quest::ding();
	quest::exp(165700);
    quest::givecash(0,0,0,30);
	}
	elsif ($ulevel == 25 && plugin::check_handin(\%itemcount, 120152 => 1)) {
	quest::say("So, Greed got the better of him eh? Lets hope he has learned his lesson.");
    quest::ding();
	quest::exp(180100);
    quest::givecash(0,0,0,30);
	}
	elsif ($ulevel == 26 && plugin::check_handin(\%itemcount, 120152 => 1)) {
	quest::say("So, Greed got the better of him eh? Lets hope he has learned his lesson.");
    quest::ding();
	quest::exp(195100);
    quest::givecash(0,0,0,30);
	}
	elsif ($ulevel == 27 && plugin::check_handin(\%itemcount, 120152 => 1)) {
	quest::say("So, Greed got the better of him eh? Lets hope he has learned his lesson.");
    quest::ding();
	quest::exp(210700);
    quest::givecash(0,0,0,30);
	}
	elsif ($ulevel == 28 && plugin::check_handin(\%itemcount, 120152 => 1)) {
	quest::say("So, Greed got the better of him eh? Lets hope he has learned his lesson.");
    quest::ding();
	quest::exp(226900);
    quest::givecash(0,0,0,30);
	}
	elsif ($ulevel == 29 && plugin::check_handin(\%itemcount, 120152 => 1)) {
	quest::say("So, Greed got the better of him eh? Lets hope he has learned his lesson.");
    quest::ding();
	quest::exp(243700);
    quest::givecash(0,0,0,30);
	}
	elsif ($ulevel == 30 && plugin::check_handin(\%itemcount, 120152 => 1)) {
	quest::say("So, Greed got the better of him eh? Lets hope he has learned his lesson.");
    quest::ding();
	quest::exp(531100);
    quest::givecash(0,0,0,30);
	}
elsif ($ulevel == 21 && plugin::check_handin(\%itemcount, 56023 => 4)) {
   quest::say("Not as easy as I made it sound eh? Oh well if everyone could do it there would not be any challenge.");
   quest::ding();
   quest::exp(126100);
   quest::givecash(0,0,0,30);
   }   
   elsif ($ulevel == 22 && plugin::check_handin(\%itemcount, 56023 => 4)) {
   quest::say("Not as easy as I made it sound eh? Oh well if everyone could do it there would not be any challenge.");
   quest::ding();
   quest::exp(138700);
   quest::givecash(0,0,0,30);
   }   
   elsif ($ulevel == 23 && plugin::check_handin(\%itemcount, 56023 => 4)) {
   quest::say("Not as easy as I made it sound eh? Oh well if everyone could do it there would not be any challenge.");
   quest::ding();
   quest::exp(151900);
   quest::givecash(0,0,0,30);
   } 
elsif ($ulevel == 24 && plugin::check_handin(\%itemcount, 56023 => 4)) {
   quest::say("Not as easy as I made it sound eh? Oh well if everyone could do it there would not be any challenge.");
   quest::ding();
   quest::exp(165700);
   quest::givecash(0,0,0,30);
   }   
   elsif ($ulevel == 25 && plugin::check_handin(\%itemcount, 56023 => 4)) {
   quest::say("Not as easy as I made it sound eh? Oh well if everyone could do it there would not be any challenge.");
   quest::ding();
   quest::exp(180100);
   quest::givecash(0,0,0,30);
   }  
   elsif ($ulevel == 26 && plugin::check_handin(\%itemcount, 56023 => 4)) {
   quest::say("Not as easy as I made it sound eh? Oh well if everyone could do it there would not be any challenge.");
   quest::ding();
   quest::exp(195100);
   quest::givecash(0,0,0,30);
   }    
   elsif ($ulevel == 27 && plugin::check_handin(\%itemcount, 56023 => 4)) {
   quest::say("Not as easy as I made it sound eh? Oh well if everyone could do it there would not be any challenge.");
   quest::ding();
   quest::exp(210700);
   quest::givecash(0,0,0,30);
   }   
   elsif ($ulevel == 28 && plugin::check_handin(\%itemcount, 56023 => 4)) {
   quest::say("Not as easy as I made it sound eh? Oh well if everyone could do it there would not be any challenge.");
   quest::ding();
   quest::exp(226900);
   quest::givecash(0,0,0,30);
   }    
   elsif ($ulevel == 29 && plugin::check_handin(\%itemcount, 56023 => 4)) {
   quest::say("Not as easy as I made it sound eh? Oh well if everyone could do it there would not be any challenge.");
   quest::ding();
   quest::exp(243700);
   quest::givecash(0,0,0,30);
   }    
   elsif ($ulevel == 30 && plugin::check_handin(\%itemcount, 56023 => 4)) {
   quest::say("Not as easy as I made it sound eh? Oh well if everyone could do it there would not be any challenge.");
   quest::ding();
   quest::exp(531100);
   quest::givecash(0,0,0,30);
   }      
elsif ($ulevel == 21 && plugin::check_handin(\%itemcount, 120179 => 1)) { 
   ...
   elsif ($ulevel == 22 && plugin::check_handin(\%itemcount, 120179 => 1)) { 
   quest::say("Back already? These fangs will do nicely,  the Norrath Keepers use them to make thier blades even more deadly. Here is your cut.");
   quest::ding();
   quest::exp(138700);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 23 && plugin::check_handin(\%itemcount, 120179 => 1)) { 
   quest::say("Back already? These fangs will do nicely,  the Norrath Keepers use them to make thier blades even more deadly. Here is your cut.");
   quest::ding();
   quest::exp(151900);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 24 && plugin::check_handin(\%itemcount, 120179 => 1)) { 
   quest::say("Back already? These fangs will do nicely,  the Norrath Keepers use them to make thier blades even more deadly. Here is your cut.");
   quest::ding();
   quest::exp(165700);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 25 && plugin::check_handin(\%itemcount, 120179 => 1)) { 
   quest::say("Back already? These fangs will do nicely,  the Norrath Keepers use them to make thier blades even more deadly. Here is your cut.");
   quest::ding();
   quest::exp(180100);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 26 && plugin::check_handin(\%itemcount, 120179 => 1)) { 
   quest::say("Back already? These fangs will do nicely,  the Norrath Keepers use them to make thier blades even more deadly. Here is your cut.");
   quest::ding();
   quest::exp(195100);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 27 && plugin::check_handin(\%itemcount, 120179 => 1)) { 
   quest::say("Back already? These fangs will do nicely,  the Norrath Keepers use them to make thier blades even more deadly. Here is your cut.");
   quest::ding();
   quest::exp(210700);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 28 && plugin::check_handin(\%itemcount, 120179 => 1)) { 
   quest::say("Back already? These fangs will do nicely,  the Norrath Keepers use them to make thier blades even more deadly. Here is your cut.");
   quest::ding();
   quest::exp(226900);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 29 && plugin::check_handin(\%itemcount, 120179 => 1)) { 
   quest::say("Back already? These fangs will do nicely,  the Norrath Keepers use them to make thier blades even more deadly. Here is your cut.");
   quest::ding();
   quest::exp(243700);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 30 && plugin::check_handin(\%itemcount, 120179 => 1)) { 
   quest::say("Back already? These fangs will do nicely,  the Norrath Keepers use them to make thier blades even more deadly. Here is your cut.");
   quest::ding();
   quest::exp(531100);
   quest::givecash(0,0,0,30);
   }
elsif ($ulevel == 21 && plugin::check_handin(\%itemcount, 120184 => 1)) {
   ...
   elsif ($ulevel == 22 && plugin::check_handin(\%itemcount, 120184 => 1)) {
   quest::say("Thank you $name, I have indeed been waiting on this. Whats it for? That I can not tell you, lets just say Tumpy's Tonic is water compared to this stuff.");
   quest::ding();
   quest::exp(138700);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 23 && plugin::check_handin(\%itemcount, 120184 => 1)) {
   quest::say("Thank you $name, I have indeed been waiting on this. Whats it for? That I can not tell you, lets just say Tumpy's Tonic is water compared to this stuff.");
   quest::ding();
   quest::exp(151900);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 24 && plugin::check_handin(\%itemcount, 120184 => 1)) {
   quest::say("Thank you $name, I have indeed been waiting on this. Whats it for? That I can not tell you, lets just say Tumpy's Tonic is water compared to this stuff.");
   quest::ding();
   quest::exp(165700);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 25 && plugin::check_handin(\%itemcount, 120184 => 1)) {
   quest::say("Thank you $name, I have indeed been waiting on this. Whats it for? That I can not tell you, lets just say Tumpy's Tonic is water compared to this stuff.");
   quest::ding();
   quest::exp(180100);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 26 && plugin::check_handin(\%itemcount, 120184 => 1)) {
   quest::say("Thank you $name, I have indeed been waiting on this. Whats it for? That I can not tell you, lets just say Tumpy's Tonic is water compared to this stuff.");
   quest::ding();
   quest::exp(195100);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 27 && plugin::check_handin(\%itemcount, 120184 => 1)) {
   quest::say("Thank you $name, I have indeed been waiting on this. Whats it for? That I can not tell you, lets just say Tumpy's Tonic is water compared to this stuff.");
   quest::ding();
   quest::exp(210700);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 28 && plugin::check_handin(\%itemcount, 120184 => 1)) {
   quest::say("Thank you $name, I have indeed been waiting on this. Whats it for? That I can not tell you, lets just say Tumpy's Tonic is water compared to this stuff.");
   quest::ding();
   quest::exp(226900);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 29 && plugin::check_handin(\%itemcount, 120184 => 1)) {
   quest::say("Thank you $name, I have indeed been waiting on this. Whats it for? That I can not tell you, lets just say Tumpy's Tonic is water compared to this stuff.");
   quest::ding();
   quest::exp(243700);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 30 && plugin::check_handin(\%itemcount, 120184 => 1)) {
   quest::say("Thank you $name, I have indeed been waiting on this. Whats it for? That I can not tell you, lets just say Tumpy's Tonic is water compared to this stuff.");
   quest::ding();
   quest::exp(531100);
   quest::givecash(0,0,0,30);
   }
elsif ($ulevel == 21 && plugin::check_handin(\%itemcount, 120180 => 2, 120181 => 2)) {   
   ...
   elsif ($ulevel == 22 && plugin::check_handin(\%itemcount, 120180 => 2, 120181 => 2)) {   
   quest::say("With the pests dead we can resume our activities in Lavaspinner's lair. We shall call upon you again should any further infestations be found.");
   quest::ding();
   quest::exp(138700);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 23 && plugin::check_handin(\%itemcount, 120180 => 2, 120181 => 2)) {   
   quest::say("With the pests dead we can resume our activities in Lavaspinner's lair. We shall call upon you again should any further infestations be found.");
   quest::ding();
   quest::exp(151900);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 24 && plugin::check_handin(\%itemcount, 120180 => 2, 120181 => 2)) {   
   quest::say("With the pests dead we can resume our activities in Lavaspinner's lair. We shall call upon you again should any further infestations be found.");
   quest::ding();
   quest::exp(165700);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 25 && plugin::check_handin(\%itemcount, 120180 => 2, 120181 => 2)) {   
   quest::say("With the pests dead we can resume our activities in Lavaspinner's lair. We shall call upon you again should any further infestations be found.");
   quest::ding();
   quest::exp(180100);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 26 && plugin::check_handin(\%itemcount, 120180 => 2, 120181 => 2)) {   
   quest::say("With the pests dead we can resume our activities in Lavaspinner's lair. We shall call upon you again should any further infestations be found.");
   quest::ding();
   quest::exp(195100);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 27 && plugin::check_handin(\%itemcount, 120180 => 2, 120181 => 2)) {   
   quest::say("With the pests dead we can resume our activities in Lavaspinner's lair. We shall call upon you again should any further infestations be found.");
   quest::ding();
   quest::exp(210700);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 28 && plugin::check_handin(\%itemcount, 120180 => 2, 120181 => 2)) {   
   quest::say("With the pests dead we can resume our activities in Lavaspinner's lair. We shall call upon you again should any further infestations be found.");
   quest::ding();
   quest::exp(226900);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 29 && plugin::check_handin(\%itemcount, 120180 => 2, 120181 => 2)) {   
   quest::say("With the pests dead we can resume our activities in Lavaspinner's lair. We shall call upon you again should any further infestations be found.");
   quest::ding();
   quest::exp(243700);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 30 && plugin::check_handin(\%itemcount, 120180 => 2, 120181 => 2)) {   
   quest::say("With the pests dead we can resume our activities in Lavaspinner's lair. We shall call upon you again should any further infestations be found.");
   quest::ding();
   quest::exp(531100);
   quest::givecash(0,0,0,30);
   }
elsif ($ulevel == 21 && plugin::check_handin(\%itemcount, 85012 => 3, 85013 => 1)) {   
   ...
   elsif ($ulevel == 22 && plugin::check_handin(\%itemcount, 85012 => 3, 85013 => 1)) {   
   quest::say("The egg sacks have been collected! Thank you for your efforts to further our research, you may have saved the lives of many people.");
   quest::ding();
   quest::exp(138700);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 23 && plugin::check_handin(\%itemcount, 85012 => 3, 85013 => 1)) {   
   quest::say("The egg sacks have been collected! Thank you for your efforts to further our research, you may have saved the lives of many people.");
   quest::ding();
   quest::exp(151900);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 24 && plugin::check_handin(\%itemcount, 85012 => 3, 85013 => 1)) {   
   quest::say("The egg sacks have been collected! Thank you for your efforts to further our research, you may have saved the lives of many people.");
   quest::ding();
   quest::exp(165700);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 25 && plugin::check_handin(\%itemcount, 85012 => 3, 85013 => 1)) {   
   quest::say("The egg sacks have been collected! Thank you for your efforts to further our research, you may have saved the lives of many people.");
   quest::ding();
   quest::exp(180100);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 26 && plugin::check_handin(\%itemcount, 85012 => 3, 85013 => 1)) {   
   quest::say("The egg sacks have been collected! Thank you for your efforts to further our research, you may have saved the lives of many people.");
   quest::ding();
   quest::exp(195100);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 27 && plugin::check_handin(\%itemcount, 85012 => 3, 85013 => 1)) {   
   quest::say("The egg sacks have been collected! Thank you for your efforts to further our research, you may have saved the lives of many people.");
   quest::ding();
   quest::exp(210700);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 28 && plugin::check_handin(\%itemcount, 85012 => 3, 85013 => 1)) {   
   quest::say("The egg sacks have been collected! Thank you for your efforts to further our research, you may have saved the lives of many people.");
   quest::ding();
   quest::exp(226900);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 29 && plugin::check_handin(\%itemcount, 85012 => 3, 85013 => 1)) {   
   quest::say("The egg sacks have been collected! Thank you for your efforts to further our research, you may have saved the lives of many people.");
   quest::ding();
   quest::exp(243700);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 30 && plugin::check_handin(\%itemcount, 85012 => 3, 85013 => 1)) {   
   quest::say("The egg sacks have been collected! Thank you for your efforts to further our research, you may have saved the lives of many people.");
   quest::ding();
   quest::exp(531100);
   quest::givecash(0,0,0,30);
   }
elsif ($ulevel == 21 && plugin::check_handin(\%itemcount, 48141 => 1, 48140 => 1, 48142 => 1)) {  
   quest::say("Good work $name. I will deliver these to the alchemist myself. Here is your part of the reward.");
   quest::ding();
   quest::exp(126100);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 22 && plugin::check_handin(\%itemcount, 48141 => 1, 48140 => 1, 48142 => 1)) {  
   quest::say("Good work $name. I will deliver these to the alchemist myself. Here is your part of the reward.");
   quest::ding();
   quest::exp(138700);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 23 && plugin::check_handin(\%itemcount, 48141 => 1, 48140 => 1, 48142 => 1)) {  
   quest::say("Good work $name. I will deliver these to the alchemist myself. Here is your part of the reward.");
   quest::ding();
   quest::exp(151900);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 24 && plugin::check_handin(\%itemcount, 48141 => 1, 48140 => 1, 48142 => 1)) {  
   quest::say("Good work $name. I will deliver these to the alchemist myself. Here is your part of the reward.");
   quest::ding();
   quest::exp(165700);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 25 && plugin::check_handin(\%itemcount, 48141 => 1, 48140 => 1, 48142 => 1)) {  
   quest::say("Good work $name. I will deliver these to the alchemist myself. Here is your part of the reward.");
   quest::ding();
   quest::exp(180100);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 26 && plugin::check_handin(\%itemcount, 48141 => 1, 48140 => 1, 48142 => 1)) {  
   quest::say("Good work $name. I will deliver these to the alchemist myself. Here is your part of the reward.");
   quest::ding();
   quest::exp(195100);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 27 && plugin::check_handin(\%itemcount, 48141 => 1, 48140 => 1, 48142 => 1)) {  
   quest::say("Good work $name. I will deliver these to the alchemist myself. Here is your part of the reward.");
   quest::ding();
   quest::exp(210700);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 28 && plugin::check_handin(\%itemcount, 48141 => 1, 48140 => 1, 48142 => 1)) {  
   quest::say("Good work $name. I will deliver these to the alchemist myself. Here is your part of the reward.");
   quest::ding();
   quest::exp(226900);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 29 && plugin::check_handin(\%itemcount, 48141 => 1, 48140 => 1, 48142 => 1)) {  
   quest::say("Good work $name. I will deliver these to the alchemist myself. Here is your part of the reward.");
   quest::ding();
   quest::exp(243700);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 30 && plugin::check_handin(\%itemcount, 48141 => 1, 48140 => 1, 48142 => 1)) {  
   quest::say("Good work $name. I will deliver these to the alchemist myself. Here is your part of the reward.");
   quest::ding();
   quest::exp(531100);
   quest::givecash(0,0,0,30);
   }
elsif ($ulevel == 21 && plugin::check_handin(\%itemcount, 120182 => 1, 120183 => 1)) {  
   quest::say("Well done $name. That should slow down the invaision. Here is you half of the reward.");
   quest::ding();
   quest::exp(126100);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 22 && plugin::check_handin(\%itemcount, 120182 => 1, 120183 => 1)) {  
   quest::say("Well done $name. That should slow down the invaision. Here is you half of the reward.");
   quest::ding();
   quest::exp(138700);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 23 && plugin::check_handin(\%itemcount, 120182 => 1, 120183 => 1)) {  
   quest::say("Well done $name. That should slow down the invaision. Here is you half of the reward.");
   quest::ding();
   quest::exp(151900);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 24 && plugin::check_handin(\%itemcount, 120182 => 1, 120183 => 1)) {  
   quest::say("Well done $name. That should slow down the invaision. Here is you half of the reward.");
   quest::ding();
   quest::exp(165700);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 25 && plugin::check_handin(\%itemcount, 120182 => 1, 120183 => 1)) {  
   quest::say("Well done $name. That should slow down the invaision. Here is you half of the reward.");
   quest::ding();
   quest::exp(108100);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 26 && plugin::check_handin(\%itemcount, 120182 => 1, 120183 => 1)) {  
   quest::say("Well done $name. That should slow down the invaision. Here is you half of the reward.");
   quest::ding();
   quest::exp(195100);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 27 && plugin::check_handin(\%itemcount, 120182 => 1, 120183 => 1)) {  
   quest::say("Well done $name. That should slow down the invaision. Here is you half of the reward.");
   quest::ding();
   quest::exp(210700);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 28 && plugin::check_handin(\%itemcount, 120182 => 1, 120183 => 1)) {  
   quest::say("Well done $name. That should slow down the invaision. Here is you half of the reward.");
   quest::ding();
   quest::exp(226900);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 29 && plugin::check_handin(\%itemcount, 120182 => 1, 120183 => 1)) {  
   quest::say("Well done $name. That should slow down the invaision. Here is you half of the reward.");
   quest::ding();
   quest::exp(243700);
   quest::givecash(0,0,0,30);
   }
   elsif ($ulevel == 30 && plugin::check_handin(\%itemcount, 120182 => 1, 120183 => 1)) {  
   quest::say("Well done $name. That should slow down the invaision. Here is you half of the reward.");
   quest::ding();
   quest::exp(531100);
   quest::givecash(0,0,0,30);
