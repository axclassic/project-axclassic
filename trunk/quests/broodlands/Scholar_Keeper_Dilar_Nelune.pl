sub EVENT_SAY {
   ...
   quest::say("Gimblax was said to be holding up in Tirranun's Delve, that would be a good place to start your search, return to Scholar Relae Aderi with the Uncut Goshenite as proof of your victory.");
   }
   ...
   quest::say("Perhaps he didnt loose his pet as much as the pet ran away. Either way I told him I would send someone to look for his pet. It was last seen in the Nest. If you find it tell it that its master is looking for it.");
...
sub EVENT_ITEM {
if ($ulevel == 51 && plugin::check_handin(\%itemcount, 92812 => 1)) {
   ...
   elsif ($ulevel == 52 && plugin::check_handin(\%itemcount, 92812 => 1)) {
   quest::say("Surprisingly, the sly Kirin turned to betrayal. Though this journey has ended on a sour note, perhaps there are still others willing to listen to offers of peace.");
   quest::ding();
   quest::exp(2599630);
   quest::givecash(0,0,0,66);
   }
   elsif ($ulevel == 53 && plugin::check_handin(\%itemcount, 92812 => 1)) {
   quest::say("Surprisingly, the sly Kirin turned to betrayal. Though this journey has ended on a sour note, perhaps there are still others willing to listen to offers of peace.");
   quest::ding();
   quest::exp(2811810);
   quest::givecash(0,0,0,66);
   }
   elsif ($ulevel == 54 && plugin::check_handin(\%itemcount, 92812 => 1)) {
   quest::say("Surprisingly, the sly Kirin turned to betrayal. Though this journey has ended on a sour note, perhaps there are still others willing to listen to offers of peace.");
   quest::ding();
   quest::exp(4609070);
   quest::givecash(0,0,0,66);
   }
   elsif ($ulevel == 55 && plugin::check_handin(\%itemcount, 92812 => 1)) {
   quest::say("Surprisingly, the sly Kirin turned to betrayal. Though this journey has ended on a sour note, perhaps there are still others willing to listen to offers of peace.");
   quest::ding();
   quest::exp(3356840);
   quest::givecash(0,0,0,66);
   }
   elsif ($ulevel == 56 && plugin::check_handin(\%itemcount, 92812 => 1)) {
   quest::say("Surprisingly, the sly Kirin turned to betrayal. Though this journey has ended on a sour note, perhaps there are still others willing to listen to offers of peace.");
   quest::ding();
   quest::exp(3604360);
   quest::givecash(0,0,0,66);
   }
   elsif ($ulevel == 57 && plugin::check_handin(\%itemcount, 92812 => 1)) {
   quest::say("Surprisingly, the sly Kirin turned to betrayal. Though this journey has ended on a sour note, perhaps there are still others willing to listen to offers of peace.");
   quest::ding();
   quest::exp(3863100);
   quest::givecash(0,0,0,66);
   }
   elsif ($ulevel == 58 && plugin::check_handin(\%itemcount, 92812 => 1)) {
   quest::say("Surprisingly, the sly Kirin turned to betrayal. Though this journey has ended on a sour note, perhaps there are still others willing to listen to offers of peace.");
   quest::ding();
   quest::exp(4133300);
   quest::givecash(0,0,0,66);
   }
   elsif ($ulevel == 59 && plugin::check_handin(\%itemcount, 92812 => 1)) {
   quest::say("Surprisingly, the sly Kirin turned to betrayal. Though this journey has ended on a sour note, perhaps there are still others willing to listen to offers of peace.");
   quest::ding();
   quest::exp(6468990);
   quest::givecash(0,0,0,66);
   }
   elsif ($ulevel == 60 && plugin::check_handin(\%itemcount, 92812 => 1)) {
   quest::say("Surprisingly, the sly Kirin turned to betrayal. Though this journey has ended on a sour note, perhaps there are still others willing to listen to offers of peace.");
   quest::ding();
   quest::exp(2855560);
   quest::givecash(0,0,0,66);
   ...
   elsif ($ulevel == 62 && plugin::check_handin(\%itemcount, 60264 => 1)) {
   quest::say("You have bested beasts of incredible power against all odds to recover long-protected artifacts of the great storm dragon, Yar`Lir. You are on a path to uncovering the mysteries of the Nest and why it was kept hidden in front of your very eyes for so long.");
   quest::ding();
   quest::exp(2950220);
   quest::givecash(0,0,0,75);
   }
   elsif ($ulevel == 63 && plugin::check_handin(\%itemcount, 60264 => 1)) {
   quest::say("You have bested beasts of incredible power against all odds to recover long-protected artifacts of the great storm dragon, Yar`Lir. You are on a path to uncovering the mysteries of the Nest and why it was kept hidden in front of your very eyes for so long.");
   quest::ding();
   quest::exp(3042940);
   quest::givecash(0,0,0,75);
   }
   elsif ($ulevel == 64 && plugin::check_handin(\%itemcount, 60264 => 1)) {
   quest::say("You have bested beasts of incredible power against all odds to recover long-protected artifacts of the great storm dragon, Yar`Lir. You are on a path to uncovering the mysteries of the Nest and why it was kept hidden in front of your very eyes for so long.");
   quest::ding();
   quest::exp(3145220);
   quest::givecash(0,0,0,75);
   }
   elsif ($ulevel == 65 && plugin::check_handin(\%itemcount, 60264 => 1)) {
   quest::say("You have bested beasts of incredible power against all odds to recover long-protected artifacts of the great storm dragon, Yar`Lir. You are on a path to uncovering the mysteries of the Nest and why it was kept hidden in front of your very eyes for so long.");
   quest::ding();
   quest::exp(3245060);
   quest::givecash(0,0,0,75);
