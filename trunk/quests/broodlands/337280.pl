...
elsif ($ulevel == 41 && plugin::check_handin(\%itemcount, 86002 => 1)) {
   quest::say("Well done $name!,The Orb of Midwinter! Here is your reward.");
   quest::ding();
   quest::exp(639370);
   quest::givecash(0,0,0,50);
   }
   elsif ($ulevel == 42 && plugin::check_handin(\%itemcount, 86002 => 1)) {
   quest::say("Well done $name!,The Orb of Midwinter! Here is your reward.");
   quest::ding();
   quest::exp(671710);
   quest::givecash(0,0,0,50);
   }
   elsif ($ulevel == 43 && plugin::check_handin(\%itemcount, 86002 => 1)) {
   quest::say("Well done $name!,The Orb of Midwinter! Here is your reward.");
   quest::ding();
   quest::exp(704470);
   quest::givecash(0,0,0,50);
   }
   elsif ($ulevel == 44 && plugin::check_handin(\%itemcount, 86002 => 1)) {
   quest::say("Well done $name!,The Orb of Midwinter! Here is your reward.");
   quest::ding();
   quest::exp(738010);
   quest::givecash(0,0,0,50);
   }
   elsif ($ulevel == 45 && plugin::check_handin(\%itemcount, 86002 => 1)) {
   quest::say("Well done $name!,The Orb of Midwinter! Here is your reward.");
   quest::ding();
   quest::exp(1629580);
   quest::givecash(0,0,0,50);
   }
   elsif ($ulevel == 46 && plugin::check_handin(\%itemcount, 86002 => 1)) {
   quest::say("Well done $name!,The Orb of Midwinter! Here is your reward.");
   quest::ding();
   quest::exp(869540);
   quest::givecash(0,0,0,50);
   }
   elsif ($ulevel == 47 && plugin::check_handin(\%itemcount, 86002 => 1)) {
   quest::say("Well done $name!,The Orb of Midwinter! Here is your reward.");
   quest::ding();
   quest::exp(908180);
   quest::givecash(0,0,0,50);
   }
   elsif ($ulevel == 48 && plugin::check_handin(\%itemcount, 86002 => 1)) {
   quest::say("Well done $name!,The Orb of Midwinter! Here is your reward.");
   quest::ding();
   quest::exp(947660);
   quest::givecash(0,0,0,50);
   }
   elsif ($ulevel == 49 && plugin::check_handin(\%itemcount, 86002 => 1)) {
   quest::say("Well done $name!,The Orb of Midwinter! Here is your reward.");
   quest::ding();
   quest::exp(987980);
   quest::givecash(0,0,0,50);
   }
   elsif ($ulevel == 50 && plugin::check_handin(\%itemcount, 86002 => 1)) {
   quest::say("Well done $name!,The Orb of Midwinter! Here is your reward.");
   quest::ding();
   quest::exp(1029140);
   quest::givecash(0,0,0,50);
   }         
elsif ($ulevel == 41 && plugin::check_handin(\%itemcount, 120162 => 1)) {
   quest::say("Well done $name!,Maybe that will persuade the goblins to our side or at least stop them from joining the keepers.");
   quest::ding();
   quest::exp(639370);
   quest::givecash(0,0,0,50);
   }
   elsif ($ulevel == 42 && plugin::check_handin(\%itemcount, 120162 => 1)) {
   quest::say("Well done $name!,Maybe that will persuade the goblins to our side or at least stop them from joining the keepers.");
   quest::ding();
   quest::exp(671710);
   quest::givecash(0,0,0,50);
   }
   elsif ($ulevel == 43 && plugin::check_handin(\%itemcount, 120162 => 1)) {
   quest::say("Well done $name!,Maybe that will persuade the goblins to our side or at least stop them from joining the keepers.");
   quest::ding();
   quest::exp(704470);
   quest::givecash(0,0,0,50);
   }
   elsif ($ulevel == 44 && plugin::check_handin(\%itemcount, 120162 => 1)) {
   quest::say("Well done $name!,Maybe that will persuade the goblins to our side or at least stop them from joining the keepers.");
   quest::ding();
   quest::exp(738010);
   quest::givecash(0,0,0,50);
   }
   elsif ($ulevel == 45 && plugin::check_handin(\%itemcount, 120162 => 1)) {
   quest::say("Well done $name!,Maybe that will persuade the goblins to our side or at least stop them from joining the keepers.");
   quest::ding();
   quest::exp(1629580);
   quest::givecash(0,0,0,50);
   }
   elsif ($ulevel == 46 && plugin::check_handin(\%itemcount, 120162 => 1)) {
   quest::say("Well done $name!,Maybe that will persuade the goblins to our side or at least stop them from joining the keepers.");
   quest::ding();
   quest::exp(869540);
   quest::givecash(0,0,0,50);
   }
   elsif ($ulevel == 47 && plugin::check_handin(\%itemcount, 120162 => 1)) {
   quest::say("Well done $name!,Maybe that will persuade the goblins to our side or at least stop them from joining the keepers.");
   quest::ding();
   quest::exp(908180);
   quest::givecash(0,0,0,50);
   }
   elsif ($ulevel == 48 && plugin::check_handin(\%itemcount, 120162 => 1)) {
   quest::say("Well done $name!,Maybe that will persuade the goblins to our side or at least stop them from joining the keepers.");
   quest::ding();
   quest::exp(947660);
   quest::givecash(0,0,0,50);
   }
   elsif ($ulevel == 49 && plugin::check_handin(\%itemcount, 120162 => 1)) {
   quest::say("Well done $name!,Maybe that will persuade the goblins to our side or at least stop them from joining the keepers.");
   quest::ding();
   quest::exp(987980);
   quest::givecash(0,0,0,50);
   }
   elsif ($ulevel == 50 && plugin::check_handin(\%itemcount, 120162 => 1)) {
   quest::say("Well done $name!,Maybe that will persuade the goblins to our side or at least stop them from joining the keepers.");
   quest::ding();
   quest::exp(1029140);
   quest::givecash(0,0,0,50);
   }            
elsif ($ulevel == 41 && plugin::check_handin(\%itemcount, 86005 => 1)) {
   quest::say("So thats mysterious egg that Officer Vacax Rol'Tas was talking about eh?, Well it dont look like much to me but a deal is a deal.");
   quest::ding();
   quest::exp(639370);
   quest::givecash(0,0,0,50);
   }
   elsif ($ulevel == 42 && plugin::check_handin(\%itemcount, 86005 => 1)) {
   quest::say("So thats mysterious egg that Officer Vacax Rol'Tas was talking about eh?, Well it dont look like much to me but a deal is a deal.");
   quest::ding();
   quest::exp(671710);
   quest::givecash(0,0,0,50);
   }
   elsif ($ulevel == 43 && plugin::check_handin(\%itemcount, 86005 => 1)) {
   quest::say("So thats mysterious egg that Officer Vacax Rol'Tas was talking about eh?, Well it dont look like much to me but a deal is a deal.");
   quest::ding();
   quest::exp(704470);
   quest::givecash(0,0,0,50);
   }
   elsif ($ulevel == 44 && plugin::check_handin(\%itemcount, 86005 => 1)) {
   quest::say("So thats mysterious egg that Officer Vacax Rol'Tas was talking about eh?, Well it dont look like much to me but a deal is a deal.");
   quest::ding();
   quest::exp(738010);
   quest::givecash(0,0,0,50);
   }
   elsif ($ulevel == 45 && plugin::check_handin(\%itemcount, 86005 => 1)) {
   quest::say("So thats mysterious egg that Officer Vacax Rol'Tas was talking about eh?, Well it dont look like much to me but a deal is a deal.");
   quest::ding();
   quest::exp(1629580);
   quest::givecash(0,0,0,50);
   }
   elsif ($ulevel == 46 && plugin::check_handin(\%itemcount, 86005 => 1)) {
   quest::say("So thats mysterious egg that Officer Vacax Rol'Tas was talking about eh?, Well it dont look like much to me but a deal is a deal.");
   quest::ding();
   quest::exp(869540);
   quest::givecash(0,0,0,50);
   }
   elsif ($ulevel == 47 && plugin::check_handin(\%itemcount, 86005 => 1)) {
   quest::say("So thats mysterious egg that Officer Vacax Rol'Tas was talking about eh?, Well it dont look like much to me but a deal is a deal.");
   quest::ding();
   quest::exp(908180);
   quest::givecash(0,0,0,50);
   }
   elsif ($ulevel == 48 && plugin::check_handin(\%itemcount, 86005 => 1)) {
   quest::say("So thats mysterious egg that Officer Vacax Rol'Tas was talking about eh?, Well it dont look like much to me but a deal is a deal.");
   quest::ding();
   quest::exp(947660);
   quest::givecash(0,0,0,50);
   }
   elsif ($ulevel == 49 && plugin::check_handin(\%itemcount, 86005 => 1)) {
   quest::say("So thats mysterious egg that Officer Vacax Rol'Tas was talking about eh?, Well it dont look like much to me but a deal is a deal.");
   quest::ding();
   quest::exp(987980);
   quest::givecash(0,0,0,50);
   }
   elsif ($ulevel == 50 && plugin::check_handin(\%itemcount, 86005 => 1)) {
   quest::say("So thats mysterious egg that Officer Vacax Rol'Tas was talking about eh?, Well it dont look like much to me but a deal is a deal.");
   quest::ding();
   quest::exp(1029140);
   quest::givecash(0,0,0,50);
