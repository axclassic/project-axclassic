...
if ($ulevel == 21 && plugin::check_handin(\%itemcount, 120163 => 1)) {
...
elsif ($ulevel == 41 && plugin::check_handin(\%itemcount, 57201 => 1)) {
...
elsif ($ulevel == 41 && plugin::check_handin(\%itemcount, 57205 => 1)) {
   ...
   elsif ($ulevel == 62 && plugin::check_handin(\%itemcount, 57204 => 1)) {
   quest::say("Quite the challenge I would say, seems it was more of a test to see if they were strong enogh to over take us.");
   quest say("Well done, $name, I am happy you are on our side!");
   quest::ding();
   quest::exp(2950220);
   ...
   elsif ($ulevel == 63 && plugin::check_handin(\%itemcount, 57204 => 1)) {
   quest::say("Quite the challenge I would say, seems it was more of a test to see if they were strong enogh to over take us.");
   quest say("Well done, $name, I am happy you are on our side!");
   quest::ding();
   quest::exp(3042940);
   ...
   elsif ($ulevel == 64 && plugin::check_handin(\%itemcount, 57204 => 1)) {
   quest::say("Quite the challenge I would say, seems it was more of a test to see if they were strong enogh to over take us.");
   quest say("Well done, $name, I am happy you are on our side!");
   quest::ding();
   quest::exp(3145220);
   ...
   elsif ($ulevel == 65 && plugin::check_handin(\%itemcount, 57204 => 1)) {
   quest::say("Quite the challenge I would say, seems it was more of a test to see if they were strong enogh to over take us.");
   quest say("Well done, $name, I am happy you are on our side!");
   quest::ding();
   quest::exp(3245060);
