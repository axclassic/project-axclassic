...
sub EVENT_ITEM { 
  if (plugin::check_handin(\%itemcount,  18702 => 1) && $class eq "Magician") { #Old Folded Letter
   quest::say("Welcome $name. I am Eonis Mornunder, magician guild master of the Dark Reflection. I train young gnomes that feel the calling of the Plaguelord, Bertoxxulous, and wish to serve the Dark Reflection.");
