...
sub EVENT_ITEM {
	 ...
	 elsif(($platinum == 1) && plugin::check_handin(\%itemcount, 19697 => 2, 1013 => 1, 13141 => 1)) {
	 ...
	 elsif(($platinum == 1) && plugin::check_handin(\%itemcount, 19697 => 1,  1021 => 1, 13164 => 1)) {
	...
	elsif(($platinum == 1) && plugin::check_handin(\%itemcount, 19697 =>2, 1020  => 1, 20192 => 1)) {
	...
	elsif(($platinum == 1) && plugin::check_handin(\%itemcount, 19697 => 2, 1024 => 1, 22515 => 1)) {
	...
	elsif(($platinum == 1) && plugin::check_handin(\%itemcount, 19697 => 2, 1023 => 1, 13061 => 1)) {
	...
	elsif(($platinum == 1) && plugin::check_handin(\%itemcount, 19697 => 2, 1022 => 1, 16178 => 1)) {
	...
	elsif(($platinum == 2) && plugin::check_handin(\%itemcount, 19697 => 2, 1018 => 1, 16594 => 1)) {
