...
my $before = quest::saylink("before", 1);
  ...
  if($text=~/before/i) {
	quest::say("Welcome back, young Gaz. I hope your training is going well. Unfortunately I have been unable to keep up to date on your progress, but should you need advanced training in any individual skills, I am here to help you with that. As well, I am here to guide you through your growth as a Rogue in the Guktan Army. With the skills that you learn here, you will be better prepared to serve the Army.");
  }
  }
