...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 12950 => 1, 12951 => 1, 12952 => 1)){
    ...
    quest::faction(250,-15);  # Pirates of Gunthak worse
     quest::ding(); quest::exp(700000);
    quest::ding;
    quest::summonitem(5057);
  }
  else {
    quest::say("Thank you very much, however, this will not help me.  Here, have it back.  Please return when you have all I have asked for. ");
