sub EVENT_SAY{
my $Heroes = quest::saylink("Heroes", 1);
my $Fear = quest::saylink("Fear", 1);
my $past = quest::saylink("past", 1);
my $tales = quest::saylink("tales", 1);
my $two = quest::saylink("two", 1);
my $truth = quest::saylink("truth", 1);
my $visits = quest::saylink("visits", 1);
my $masters = quest::saylink("masters", 1);
my $power = quest::saylink("power", 1);
my $tribe = quest::saylink("tribe", 1);
if($text=~/Hail/i){
...
#END of FILE Zone:cabwest  ID:82046 -- Sartar_the_Unrivaled 
