...
# Note there are 3 Natasha Whitewater's in the AX-Classic DB. This quest should proc for npc_type ID 51138
...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount,28018=>1)) { # Lord Gimblox's Signet Ring
    ...
    quest::emote("lowers her head in mourning and whispers a prayer.");
