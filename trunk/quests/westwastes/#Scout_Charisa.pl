##
## Notice: 7 Kromzek Warriors with the same NPC id will not work and will crash the zone.
## Also, Kromzek Warrior with this ID already spawning from the database (that will also make the zone crash.
## Caved has this working via database spawn so quoted out.
##
...
#       quest::spawn(120121,0,0,-4896,-3507,-106); # Kromzek Warrior 
