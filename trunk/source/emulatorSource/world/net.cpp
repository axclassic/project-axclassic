...
int main(int argc, char** argv) {
	...
	database.ClearGroup();
	_log(WORLD__INIT, "Clearing temporary Bot tables..");
	database.ClearBotTemps();
	...
	_log(WORLD__INIT, "Clearing unused static zones..");
	database.ClearStatics();
