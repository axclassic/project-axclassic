...
#ifdef EQBOTS
	pTimerBotHealReuse = 901,
	pTimerBotCHealReuse = 902,	
	pTimerSpawnBotReuse = 903,
	pTimerSpawnGroupReuse = 904,
	pTimerSpawnRaidReuse = 905,
	pTimerBotEvacInUse = 906,
	pTimerCoolDownTrigger = 907,
#endif //EQBOTS	
