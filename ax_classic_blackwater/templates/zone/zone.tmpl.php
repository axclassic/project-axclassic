...
<?endif;?>
           ...
           <fieldset>
             ...
             <table width="100%" border="0" cellpadding="3" cellspacing="0">
              ...
              <tr>
                <td align="left" width="33%">Bind Others: <?=$yesno[$canbindothers]?></td>
                <td align="left" width="33%">Classic Zone: <?=$yesno[$isclassic]?></td>
                <td align="left" width="34%">Can Bot Raid: <?=$yesno[$canraid]?></td>
              </tr>
             </table>
           </fieldset>
