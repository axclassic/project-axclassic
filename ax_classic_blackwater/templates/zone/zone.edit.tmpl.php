       ...
       <fieldset>
		 ...
		 <td align="left" width="20%">
             ...
             <td align="left" width="20%">
              ...
              <td align="left" width="20%">
              Classic:  <br>
                <select name="isclassic">
                  <option value="0"<?echo ($isclassic == 0) ? " selected" : ""?>>No</option>
                  <option value="1"<?echo ($isclassic == 1) ? " selected" : ""?>>Yes</option>
                </select>
              </td>
              <td align="left" width="20%">
              Can Bot Raid:  <br>
                <select name="canraid">
                  <option value="0"<?echo ($canraid == 0) ? " selected" : ""?>>No</option>
                  <option value="1"<?echo ($canraid == 1) ? " selected" : ""?>>Yes</option>
                </select>
              </td>
             </tr>
           </table>
