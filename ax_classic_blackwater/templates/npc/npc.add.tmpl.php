         ...
         <fieldset>
           ...
           <table width="100%" border="0" cellpadding="3" cellspacing="0">
             <tr>
               ...
               <td align="left" width="14%">Runspeed:  <br><input type="text" name="runspeed" size="5" value="1.25"></td>
               <td align="left" width="14%">ATK:  <br><input type="text" name="ATK" size="5" value="0"></td>
               <td align="left" width="14%">Accuracy:  <br><input type="text" name="Accuracy" size="3" value="0"></td>
               <td align="left" width="15%">Max Level: <br><input type="text" name="maxlevel" size="3" value="0"></td>
               <td align="left" width="15%">Scalerate: <br><input type="text" name="scalerate" size="3" value="100"></td>
               <td align="left" width="15%">PvtCorpse: <br><input type="text" name="private_corpse" size="3"  value="0"></td>
               <td align="left" width="15%">UniqueSpwn: <br><input type="text" name="unique_spawn_by_name" size="3" value="0"></td> 
             </tr>
              <tr>
