...
function update_zone () {
  ...
  if ($canbindothers != $_POST['canbindothers']) $fields .= "canbindothers=\"" . $_POST['canbindothers'] . "\", ";
  if ($canraid != $_POST['canraid']) $fields .= "canraid=\"" . $_POST['canraid'] . "\", ";
  if ($isclassic != $_POST['isclassic']) $fields .= "isclassic=\"" . $_POST['isclassic'] . "\", ";
